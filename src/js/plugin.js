...
function UGFunctions() {
  ...
  (this.debugVar = ""),
    ...
    (this.getImageInsideParentData = function (e, t, i, n, r, a, s) {
      ...
      r.padding_left && (a -= r.padding_left),
        r.padding_right && (a -= r.padding_right),
        r.padding_top && (s -= r.padding_top),
        r.padding_bottom && (s -= r.padding_bottom);
      var l = null,
        u = "100%",
        d = null,
        c = null,
          ...
          (u = s),
            ...
            a > l
              ? ((l = a),
                (u = l / p),
                (c = 0),
                (d = Math.round(((u - s) / 2) * -1)))
              : ((d = 0), (c = Math.round(((l - a) / 2) * -1)));
        } else {
          var p = t / i;
          (u = s),
            (l = u * p),
    ...
    (this.getElementCenterPosition = function (e, t) {
      ...
      var l = {};
      return (
        (l.left = Math.round((s - r.width) / 2)),
        (l.top = Math.round((o - r.height) / 2)),
        t && void 0 !== t.padding_top && (l.top += t.padding_top),
        t && void 0 !== t.padding_left && (l.left += t.padding_left),
        l
      );
    }),
    ...
    (this.getElementLocalPoint = function (e, t) {
      var i = {},
        n = t.offset();
      return (
        (i.x = Math.round(e.x - n.left)), (i.y = Math.round(e.y - n.top)), i
      );
    }),
    (this.getImageOriginalSize = function (e, t, i) {
      ...
      if ("undefined" == typeof n.naturalWidth) {
        if ("number" == typeof e.data("naturalWidth")) {
          var r = {};
          return (
            (r.width = e.data("naturalWidth")),
            (r.height = e.data("naturalHeight")),
            r
          );
        }
        var a = new Image();
        return (
          ...
          a.complete
            ? ((r.width = a.width),
              (r.height = a.height),
              e.data("naturalWidth", r.width),
              e.data("naturalHeight", r.height),
              r)
            : { width: 0, height: 0 }
        );
      }
    ...
    (this.zoomImageInsideParent = function (e, t, n, r, a, s, o) {
      ...
      if (1 == t)
        ...
        if (u < x.imageWidth)
          return i.scaleImageFitParent(e, m.width, m.height, a, o), !0;
    ...
    (this.cloneElementSizeAndPos = function (e, t, n, r, a) {
      ...
      n === !0
        ? ((s.height = e.outerHeight()), (s.width = e.outerWidth()))
    ...
    (this.placeImageInsideParent = function (e, t, n, r, a, s) {
      var o = i.getImageInsideParentData(t, n, r, a, s),
        l = "<img";
      null !== o.imageWidth &&
        ((l += " width = '" + o.imageWidth + "'"),
        (o.style += "width:" + o.imageWidth + ";")),
        null != o.imageHeight &&
          ("100%" == o.imageHeight
            ? ((l += " height = '" + o.imageHeight + "'"),
              (o.style += "height:" + o.imageHeight + ";"))
            : ((l += " height = '" + o.imageHeight + "'"),
              (o.style += "height:" + o.imageHeight + "px;"))),
    ...
    (this.scaleImageCoverParent = function (e, t, n) {
      ...
      var s = i.getImageOriginalSize(e),
        ...
        p = 0;
      r > c
        ? ((c = r), (d = c / u), (p = 0), (g = Math.round(((d - a) / 2) * -1)))
        : ((g = 0), (p = Math.round(((c - r) / 2) * -1))),
        (c = Math.round(c)),
        (d = Math.round(d)),
        e.css({
          width: c + "px",
    ...
    (this.scaleImageFitParent = function (e, t, n, r, a) {
      ...
      return (
        null !== o.imageWidth &&
          ((l = !0), e.removeAttr("width"), (u.width = o.imageWidth + "px")),
        null != o.imageHeight &&
          ((l = !0), e.removeAttr("height"), (u.height = o.imageHeight + "px")),
    ...
    (this.scaleImageExactSizeInParent = function (e, t, n, r, a, s) {
      ...
      (w.width = d + "px"),
        ...
        (w["padding-left"] = g + "px"),
        (w["padding-top"] = h + "px"),
        (w["padding-right"] = p + "px"),
        (w["padding-bottom"] = m + "px"),
        e.css(w);
      var T = {};
    ...
    (this.normalizeSetting = function (e, t, i, n, r, a) {
      ...
      var s = (r - i) / (n - i);
      return (
        (r = e + (t - e) * s), 1 == a && (e > r && (r = e), r > t && (r = t)), r
      );
    }),
    ...
    (this.handleScrollTop = function (e) {
        ...
        (null === t.scrollDir &&
          (Math.abs(t.diffMouseX) > r
            ...
            : Math.abs(t.diffMouseY) > a &&
              ...
              (n.dataCache[e].scrollStartY = t.lastMouseClientY),
              (n.dataCache[e].scrollOrigin = t.scrollOrigin)),
      ...
      var s =
        ...
        t.scrollOrigin - (t.lastMouseClientY - t.scrollStartY));
    ...
    (this.updateStoredEventData = function (e, t, r) {
      ...
      (a.lastTime = jQuery.now()),
        void 0 !== s.pageX &&
          ((a.lastMouseX = s.pageX),
          (a.lastMouseY = s.pageY),
          (a.lastMouseClientY = s.clientY)),
        r && (a = jQuery.extend(a, r)),
        (n.dataCache[t] = a);
    }),
    (this.getStoredEventData = function (e, t) {
      ...
      return (
        ...
        t === !0
          ? ((i.startMousePos = i.lastMouseY),
            (i.lastMousePos = i.lastMouseY),
            (i.diffMousePos = i.diffMouseY))
          : ((i.startMousePos = i.lastMouseX),
            (i.lastMousePos = i.lastMouseX),
            (i.diffMousePos = i.diffMouseX)),
        i
      );
    }),
    ...
    (this.isTimePassed = function (e, t) {
      if (!t) var t = 100;
      var i = jQuery.now();
      0 == n.timeCache.hasOwnProperty(e)
        ? (lastTime = 0)
        : (lastTime = n.timeCache[e]);
      var r = i - lastTime;
      return (n.timeCache[e] = i), !(t >= r);
    }),
    (this.whenContiniousEventOver = function (e, t, i) {
      if (!i) var i = 300;
      1 == n.timeCache.hasOwnProperty(e) &&
        null != n.timeCache[e] &&
        (clearTimeout(n.timeCache[e]), (n.timeCache[e] = null)),
        (n.timeCache[e] = setTimeout(t, i));
    }),
    (this.validateClickTouchstartEvent = function (e) {
      var t = !0,
        i = jQuery.now() - n.lastEventTime;
      return (
        "click" == e && "touchstart" == n.lastEventType && 1e3 > i && (t = !1),
        (n.lastEventTime = jQuery.now()),
        (n.lastEventType = e),
        t
      );
    }),
      ...
      i.setButtonMobileReady(e),
        e.on("click touchstart", function (e) {
          return (
            ...
            0 == i.validateClickTouchstartEvent(e.type) || void t(objThis, e)
          );
        });
    }),
      ...
      e.on("tap", t),
        0 == i.isTouchDevice()
          ? e.on("click", function (e) {
              var t = jQuery(this);
              return (
                0 == i.validateClickTouchstartEvent(e.type) ||
                void t.trigger("tap")
              );
            })
          : (e.on("touchstart", function (e) {
              var t = jQuery(this);
              t.addClass("ug-nohover"),
                (n.lastTouchStartElement = jQuery(this)),
                (n.lastEventTime = jQuery.now());
            }),
...
function UGThumbsGeneral() {
  function e(e, t) {
    ...
    if (1 == C.thumb_wrapper_as_link) {
      ...
      var s =
        "<a href='" + o + "'" + l + " class='ug-thumb-wrapper" + n + "'></a>";
    }
    var u = jQuery(s),
      d = i.objThumbImage;
    if (0 == j.customThumbs) {
      if (1 == C.thumb_show_loader && d) {
        ...
        "bright" == C.thumb_loader_type && (c = "ug-thumb-loader-bright"),
          u.append("<div class='ug-thumb-loader " + c + "'></div>"),
          u.append("<div class='ug-thumb-error' style='display:none'></div>");
      }
      if (d) {
    ...
    return (
      j.isEffectBorder &&
        u.append("<div class='ug-thumb-border-overlay'></div>"),
  ...
  function t(e, t, i, n) {
    ...
    i
      ? (n !== !0 && i.css(r), i.find(s).css(a))
      : (x.children(".ug-thumb-wrapper").css(r), x.find(s).css(a));
  }
  function i(e, t, i, n) {
    if (!n) var n = !1;
    ...
    (a["border-width"] = t + "px"),
      ...
      n && n === !0
        ? (r.css(a), 0 == t ? r.hide() : r.show())
        : (0 == t
            ? r.stop().fadeOut(C.thumb_transition_duration)
            : r.show().stop().fadeIn(C.thumb_transition_duration),
          l(r, a));
  }
  function n(e, t, i) {
    ...
    i && i === !0 && (r = 0),
      t ? n.stop(!0).fadeTo(r, j.colorOverlayOpacity) : n.stop(!0).fadeTo(r, 0);
  }
  function r(e, t, i) {
    ...
    i && i === !0 && (a = 0),
      t ? r.stop(!0).fadeTo(a, 1) : (n.fadeTo(0, 1), r.stop(!0).fadeTo(a, 0));
  }
  function a(e, t) {
    if (
      (j.isEffectBorder &&
        i(e, C.thumb_selected_border_width, C.thumb_selected_border_color, t),
      j.isEffectOverlay)
    ) {
  ...
  function s(e) {
    ...
    return (
      ...
      1 == j.customThumbs
        ? (I.trigger(S.events.IMAGELOADERROR, e), !0)
        : (e.children(".ug-thumb-loader").hide(),
          void e.children(".ug-thumb-error").show())
    );
  }
  function o(e) {
    ...
    e
      ? (e.css(t), e.find(".ug-thumb-border-overlay").css(t))
      : x
          .find(".ug-thumb-wrapper, .ug-thumb-wrapper .ug-thumb-border-overlay")
          .css(t);
  }
  function l(e, t) {
    e.stop(!0).animate(t, {
  ...
  function d(e, i, n) {
    if (1 == C.thumb_fixed_size) P.scaleImageCoverParent(i, e);
      ...
      "height" == C.thumb_resize_by
        ? P.scaleImageByHeight(i, C.thumb_height)
        : P.scaleImageByWidth(i, C.thumb_width);
      var r = P.getElementSize(i);
      P.placeElement(i, 0, 0), t(r.width, r.height, e);
    }
    e.children(".ug-thumb-loader").hide(),
      i.show(),
      0 == C.thumb_image_overlay_effect
        ? i.fadeTo(0, 1)
        : (1 == C.thumb_image_overlay_effect && c(i), i.fadeTo(0, 0), u(e)),
      I.trigger(S.events.AFTERPLACEIMAGE, e);
  }
  function c(e) {
  ...
  function m(e) {
    return 1 == j.touchEnabled
      ? (objThumbs.off("mouseenter").off("mouseleave"), !0)
      : void (0 == p(e) && S.setThumbOverStyle(e));
  }
  function f(e) {
    return (
      1 == j.touchEnabled || void (0 == p(e) && S.setThumbNormalStyle(e, !1))
    );
  }
  function _(e, t) {
    if (!t) var t = !1;
    ...
    return (
      0 != n.parent().length &&
      ((objItem = S.getItemByThumb(n)),
      (1 != objItem.isLoaded || t !== !1) &&
        (S.triggerImageLoadedEvent(n, i),
        void (1 == j.customThumbs
          ? I.trigger(S.events.PLACEIMAGE, [n, i])
          : d(n, i, objItem))))
    );
  }
  function v(e, t, i) {
    (objItem = S.getItemByThumb(t)),
      (objItem.isLoaded = !0),
      (objItem.isThumbImageLoaded = !0);
    var n = P.getImageOriginalSize(i);
    (objItem.thumbWidth = n.width),
      (objItem.thumbHeight = n.height),
      (objItem.thumbRatioByWidth = n.width / n.height),
      (objItem.thumbRatioByHeight = n.height / n.width),
  ...
  (this.init = function (e, t) {
    ...
    (this.setThumbNormalStyle = function (e, t, a) {
      if (
        (1 == j.customThumbs && e.removeClass("ug-thumb-over"),
        j.isEffectBorder && i(e, C.thumb_border_width, C.thumb_border_color, t),
        j.isEffectOverlay)
      ) {
    ...
    (this.setThumbOverStyle = function (e) {
      if (
        (1 == j.customThumbs && e.addClass("ug-thumb-over"),
        j.isEffectBorder &&
          i(e, C.thumb_over_border_width, C.thumb_over_border_color),
        j.isEffectOverlay)
      ) {
    ...
    (this.setHtmlProperties = function (e) {
      ...
      if (
        (0 == j.customThumbs &&
          (1 == C.thumb_fixed_size && t(C.thumb_width, C.thumb_height, e),
          o(e)),
        e.each(function () {
          var e = jQuery(this);
          u(e);
        ...
        if (P.isRgbaSupported()) {
          var n = P.convertHexToRGB(
            C.thumb_overlay_color,
            C.thumb_overlay_opacity
          );
          i["background-color"] = n;
        } else
          (i["background-color"] = C.thumb_overlay_color),
            (j.colorOverlayOpacity = C.thumb_overlay_opacity);
    ...
    (this.setThumbSelected = function (e) {
      return (
        1 == j.customThumbs && e.removeClass("ug-thumb-over"),
        1 == p(e) || (e.addClass("ug-thumb-selected"), void a(e))
      );
    }),
    (this.setThumbUnselected = function (e) {
      e.removeClass("ug-thumb-selected"),
        S.setThumbNormalStyle(e, !1, "set unselected");
    }),
    ...
    (this.destroy = function () {
      var e = ".ug-thumb-wrapper";
      x.off("touchstart", e),
        w.off(A.eventSizeChange),
        x.off("mouseenter", e),
        x.off("mouseleave", e),
        I.off(S.events.THUMB_IMAGE_LOADED);
    }),
...
function UGThumbsStrip() {
  function e(e, i) {
    (I = e.getObjects()),
      ...
      1 == L &&
        ((N = jQuery.extend(N, G)),
        (N = jQuery.extend(N, i)),
        (i.thumb_resize_by = "width")),
      H.init(e, i),
      t();
  }
  function t() {
    var e = H.getOptions();
    (D.isNotFixedThumbs = e.thumb_fixed_size === !1),
      (L = N.strip_vertical_type);
  }
  function n() {
    H.setHtmlProperties(),
      ...
      o(),
      0 == D.isRunOnce &&
        (1 == N.strip_control_touch &&
          ((M = new UGTouchThumbsControl()), M.init(z)),
        1 == N.strip_control_avia && ((A = new UGAviaControl()), A.init(z)),
        m(),
        H.loadThumbsImages(),
        y()),
      (D.isRunOnce = !0);
  ...
  function r(e) {
    (R.stripSize = e),
      0 == L
        ? (R.stripActiveSize =
            R.stripSize - N.strip_padding_left - N.strip_padding_right)
        : (R.stripActiveSize =
            R.stripSize - N.strip_padding_top - N.strip_padding_bottom),
  ...
  function a() {
    ...
    0 == L
      ? ((R.thumbSize = i),
        1 == a.thumb_fixed_size
          ? (R.thumbSecondSize = n)
          : (R.thumbSecondSize = a.thumb_height),
        r(C.width()),
        (R.stripInnerSize = j.width()))
      : ((R.thumbSize = n),
        1 == a.thumb_fixed_size
          ? (R.thumbSecondSize = i)
          : (R.thumbSecondSize = a.thumb_width),
        r(C.height()),
        (R.stripInnerSize = j.height()));
  }
  function s(e) {
    0 == L ? j.width(e) : j.height(e),
      (R.stripInnerSize = e),
      m(),
      jQuery(z).trigger(z.events.INNER_SIZE_CHANGE);
  }
  function o() {
    var e = j.children(".ug-thumb-wrapper"),
      t = 0,
    ...
    for (0 == L && (n = N.strip_padding_top), i = 0; i < e.length; i++) {
      ...
      k.placeElement(r, t, n),
        0 == L
          ? (t += r.outerWidth() + N.strip_space_between_thumbs)
          : (n += r.outerHeight() + N.strip_space_between_thumbs);
    }
  ...
  function m() {
    var e = w();
    1 == e
      ? (A && A.enable(), M && M.enable())
      : (A && A.disable(), M && M.disable());
  }
  function f() {
    return (
      !w() &&
      void (0 == L
        ? k.placeElement(j, N.strip_thumbs_align, 0)
        : k.placeElement(j, 0, N.strip_thumbs_align))
    );
  }
  function _(e) {
  ...
  function T() {
    ...
    return (
      (e.minPosThumbs = -1 * t + 1),
      (e.maxPosThumbs = -1 * t + R.stripSize - 1),
      e
    );
  }
  function x(e) {
    ...
    return (
      0 == L
        ? ((t.min = i.left), (t.max = i.left + R.thumbSize))
        : ((t.min = i.top), (t.max = i.top + R.thumbSize)),
      t
    );
  }
  var S,
  ...
  (this.setHtml = function (e) {
    ...
    (this.destroy = function () {
      ...
      e.off("click"),
        e.off("touchend"),
        S.off(O.events.ITEM_CHANGE),
        jQuery(H).off(H.events.AFTERPLACEIMAGE),
        M && M.destroy(),
        A && A.destroy(),
        H.destroy();
    }),
    ...
    (this.getInnerStripLimits = function () {
      ...
      return (
        0 == L
          ? (e.maxPos = N.strip_padding_left)
          : (e.maxPos = N.strip_padding_top),
        (e.minPos = -(R.stripInnerSize - R.stripActiveSize)),
        e
      );
    }),
    ...
    (this.resize = function (e) {
      0 == L
        ? (C.width(e),
          (R.stripActiveSize =
            e - N.strip_padding_left - N.strip_padding_right))
        : (C.height(e),
          (R.stripActiveSize =
            e - N.strip_padding_top - N.strip_padding_bottom)),
        r(e),
        m(),
        h(),
        f(),
...
function UGTouchThumbsControl() {
  function e() {
    var e = jQuery.now(),
      t = {};
    return (
      (t.passedTime = S.lastTime - S.startTime),
      (t.lastActiveTime = e - S.buttonReleaseTime),
      (t.passedDistance = S.lastPos - S.startPos),
      (t.passedDistanceAbs = Math.abs(t.passedDistance)),
      t
    );
  }
  function t() {
    x.thumb_touch_slowFactor = T.normalizeSetting(
      5e-5,
      0.01,
      1,
      100,
      y.strip_thumb_touch_sensetivity,
      !0
    );
  }
  function i(e) {
  ...
  function r(e) {
    ...
    (S.mousePos = e),
      ...
      (S.lastDeltaTime = 0),
      (S.lastDeltaPos = 0),
      (S.startTime = jQuery.now()),
      (S.startPos = S.innerPos),
      (S.lastTime = S.startTime),
      (S.lastPos = S.startPos),
      (S.speed = 0);
  }
  function a() {
    var e = jQuery.now(),
    ...
    t >= x.touch_portion_time &&
      ((S.lastDeltaTime = e - S.lastTime),
      S.lastDeltaTime > x.touch_portion_time &&
        (S.lastDeltaTime = x.touch_portion_time),
      (S.lastDeltaPos = S.lastPos - S.lastPortionPos),
      (S.lastPortionPos = S.lastPos),
      (S.lastTime = e));
  }
  function s() {
    ...
    t > a &&
      S.lastDeltaTime > 0 &&
      ((a = S.lastDeltaTime), (s = S.lastDeltaPos + s)),
      t > a && (a = t);
    var l = s > 0 ? 1 : -1,
      u = 0;
    a > 0 && (u = s / a);
  ...
  function l() {
    return (
      1 == S.loop_active ||
      ((S.loop_active = !0), void (S.handle = setInterval(a, 10)))
    );
  }
  function u(e) {
  ...
  function d(e) {
    return (
      0 == S.isControlEnabled ||
      ((S.buttonReleaseTime = jQuery.now()),
      0 == S.touch_active
        ? (u(e), !0)
        : (e.preventDefault(),
          (S.touch_active = !1),
          u(e),
          void v.removeClass("ug-dragging")))
    );
  }
  function c(e) {
  ...
  function g(e) {
    ...
    if ((e.preventDefault(), 0 == e.buttons))
      return (S.touch_active = !1), u(e), !0;
    var t = i(e);
    (S.lastPos = h.getInnerStripPos()), n(t), a();
  }
  function p() {
    v.bind("mousedown touchstart", c),
      jQuery(window).add("body").bind("mouseup touchend", d),
      jQuery("body").bind("mousemove touchmove", g);
  }
  var h,
    m,
    f,
  ...
  (this.init = function (e, t, i, a, l) {
    ...
    (this.setHtml = function (e) {
      ...
      if (
        (1 == t &&
          ((l = new UGPanelHandle()),
          l.init(r, a, s, n.panelType, d),
          l.setHtml()),
        n.isDisabledAtStart === !0)
      ) {
    ...
    (this.openPanel = function (s) {
      ...
      return (
        ...
        0 != n.isClosed &&
        ((n.isClosed = !1),
        o.trigger(r.events.OPEN_PANEL),
        void (s === !1 ? e(n.originalPos, i) : (t(n.originalPos), i())))
      );
    }),
    (this.closePanel = function (s) {
      ...
      (n.isClosed = !0),
        o.trigger(r.events.CLOSE_PANEL),
        s === !1 ? e(l, i) : (t(l), i());
    }),
    ...
    (this.setDisabledAtStart = function (e) {
      return (
        !(0 >= e) &&
        ((n.isDisabledAtStart = !0), void (n.disabledAtStartTimeout = e))
      );
    });
}
function UGPanelHandle() {
  ...
  function n(e) {
    return (
      e.stopPropagation(),
      e.stopImmediatePropagation(),
      0 == l.validateClickTouchstartEvent(e.type) ||
        void (s.isPanelClosed() ? s.openPanel() : s.closePanel())
    );
  }
  function r() {
    ...
    switch (e) {
      case "right":
      case "left":
        "top" != u.panel_handle_align &&
          "bottom" != u.panel_handle_align &&
          (u.panel_handle_align = "top");
        break;
      case "bottom":
        "left" != u.panel_handle_align &&
          "right" != u.panel_handle_align &&
          (u.panel_handle_align = "left");
        break;
      case "top":
        "left" != u.panel_handle_align &&
          "right" != u.panel_handle_align &&
          (u.panel_handle_align = "right");
    }
  }
  var a,
    s,
  ...
  (this.init = function (e, t, i, n, r) {
    switch (((s = e), (a = t), n)) {
      case "grid":
        (u.panel_handle_align = i.gridpanel_handle_align),
          (u.panel_handle_offset = i.gridpanel_handle_offset),
          (u.panel_handle_skin = i.gridpanel_handle_skin);
        break;
      case "strip":
        (u.panel_handle_align = i.strippanel_handle_align),
          (u.panel_handle_offset = i.strippanel_handle_offset),
          (u.panel_handle_skin = i.strippanel_handle_skin);
        break;
      default:
    ...
    (this.setHtml = function () {
      ...
      a.append(
        "<div class='" + t + " ug-skin-" + u.panel_handle_skin + "'></div>"
      ),
        (o = a.children(".ug-panel-handle-tip"));
    }),
    (this.initEvents = function () {
      l.addClassOnHover(o),
    ...
    (this.destroy = function () {
      l.destroyButton(o),
        jQuery(s).off(s.events.OPEN_PANEL),
        jQuery(s).off(s.events.CLOSE_PANEL);
    }),
      ...
      switch (t) {
        ...
        case "right":
          l.placeElement(
            o,
            -e.width,
            u.panel_handle_align,
            0,
            u.panel_handle_offset
          );
          break;
        case "top":
          l.placeElement(
...
function UGStripPanel() {
  function e(e, t) {
    ...
    var i = !1;
    1 == C.strippanel_vertical_type && ((C = jQuery.extend(C, j)), (i = !0)),
      0 == C.strippanel_enable_buttons && ((C = jQuery.extend(C, A)), (i = !0)),
      1 == i && (C = jQuery.extend(C, t));
    var n = S.getOptions(),
      r = n.gallery_skin;
    "" == C.strippanel_buttons_skin && (C.strippanel_buttons_skin = r),
      (v = S.getElement()),
      P.init(S, M, T, C, x),
      (E = new UGThumbsStrip()),
      E.init(S, C);
  ...
  function i() {
    return (
      (1 != M.isFirstRun || 0 != t()) &&
      (E.run(), o(), d(), f(), (M.isFirstRun = !1), void p())
    );
  }
  function n(e) {
    if (!e) var e = v;
    if (
      (e.append("<div class='ug-strip-panel'></div>"),
      (b = e.children(".ug-strip-panel")),
    ...
    P.setHtml(b),
      E.setHtml(b),
      1 == C.strippanel_enable_buttons &&
        ((w = b.children("." + t)), (y = b.children("." + i))),
      r();
  }
  function r() {
    "" != C.strippanel_background_color &&
      b.css("background-color", C.strippanel_background_color);
  }
  function a() {
    var e = E.getHeight(),
      t = M.panelWidth;
  ...
  function l() {
    ...
    y && (e += y.outerWidth() + C.strippanel_padding_buttons),
      E.setPosition(e, C.strippanel_padding_top);
  }
  function u() {
    y &&
      (I.placeElement(
    ...
    y && (e += y.outerHeight() + C.strippanel_padding_buttons),
      E.setPosition(C.strippanel_padding_left, e);
  }
  function d() {
  ...
  function c(e) {
    return (
      !!I.isButtonDisabled(e) ||
      void ("advance_item" == C.strippanel_buttons_role
        ? S.nextItem()
        : E.scrollForeward())
    );
  }
  ...
  function p() {
    if (!y) return !0;
    if (0 == E.isMoveEnabled())
      return I.disableButton(w), I.disableButton(y), !0;
    var e = E.getInnerStripLimits(),
      t = E.getInnerStripPos();
    t >= e.maxPos ? I.disableButton(w) : I.enableButton(w),
      t <= e.minPos ? I.disableButton(y) : I.enableButton(y);
  }
  function h() {
    p();
  }
  function m() {
    S.isLastItem() ? I.disableButton(y) : I.enableButton(y),
      S.isFirstItem() ? I.disableButton(w) : I.enableButton(w);
  }
  function f() {
    if (1 == M.isEventsInited) return !1;
    if (((M.isEventsInited = !0), y))
      if (
        (I.addClassOnHover(y, "ug-button-hover"),
        I.addClassOnHover(w, "ug-button-hover"),
        I.setButtonOnClick(w, g),
        I.setButtonOnClick(y, c),
        "advance_item" != C.strippanel_buttons_role)
      )
        jQuery(E).on(E.events.STRIP_MOVE, h),
          jQuery(E).on(E.events.INNER_SIZE_CHANGE, p),
          _.on(S.events.SIZE_CHANGE, p);
      else {
        var e = S.getOptions();
  ...
  (this.destroy = function () {
    y &&
      (I.destroyButton(y),
      I.destroyButton(w),
      jQuery(E).off(E.events.STRIP_MOVE),
      jQuery(S).off(S.events.ITEM_CHANGE),
      jQuery(S).off(S.events.SIZE_CHANGE)),
      P.destroy(),
      E.destroy();
  }),
...
function UGGridPanel() {
  function e(e, i) {
    (P = e),
      ...
      i &&
        i.vertical_scroll &&
        (M.gridpanel_vertical_scroll = i.vertical_scroll),
      (M = jQuery.extend(M, i)),
      1 == k.isHorType
        ? ((M = jQuery.extend(M, O)), (M = jQuery.extend(M, i)))
        : 1 == M.gridpanel_vertical_scroll &&
          ((M = jQuery.extend(M, z)),
          (M = jQuery.extend(M, i)),
          (M.grid_panes_direction = "bottom"));
    var n = P.getOptions(),
      r = n.gallery_skin;
  ...
  function r() {
    "" != M.gridpanel_background_color &&
      T.css("background-color", M.gridpanel_background_color);
  }
  function a() {
  ...
  function s() {
    ...
    return (
      1 == M.gridpanel_vertical_scroll && (e *= 2),
      (e += M.gridpanel_padding_border_top + M.gridpanel_padding_border_bottom),
      (t = k.panelHeight - e)
    );
  }
  function o() {
    ...
    var n = C.getElementSize(x),
      r = n.width;
    return (
      (e += 2 * (r + M.gridpanel_arrows_padding_hor)), (t = k.panelWidth - e)
    );
  }
  function l() {
    var e = !1;
    ...
    1 == e
      ? (x.show().fadeTo(0, 1), S.show().fadeTo(0, 1), (k.arrowsVisible = !0))
      : (x.hide(), S.hide(), (k.arrowsVisible = !1));
  }
  function u() {
    var e = j.getSize();
    1 == k.isHorType
      ? (k.panelHeight =
          e.height +
          M.gridpanel_padding_border_top +
          M.gridpanel_padding_border_bottom)
      : (k.panelWidth =
          e.width +
          M.gridpanel_padding_border_left +
          M.gridpanel_padding_border_right),
  ...
  function d() {
    return (
      1 != k.isEventsInited &&
      ((k.isEventsInited = !0),
      S && (C.addClassOnHover(S), j.attachPrevPaneButton(S)),
      x && (C.addClassOnHover(x), j.attachNextPaneButton(x)),
      void A.initEvents())
    );
  }
  function c() {
    ...
    switch (M.gridpanel_grid_align) {
      ...
      case "top":
        e =
          M.gridpanel_padding_border_top +
          r.height +
          M.gridpanel_arrows_padding_vert;
        break;
      case "middle":
        e = "middle";
        break;
  ...
  function m() {
    ...
    switch (M.gridpanel_grid_align) {
      case "middle":
        switch (M.gridpanel_arrows_align_vert) {
          ...
          case "borders":
            var l =
              k.panelHeight - r.height - M.gridpanel_padding_border_bottom;
            s = (l - a.height) / 2;
        }
        break;
      case "bottom":
    ...
    (t = -r.width / 2 - M.gridpanel_space_between_arrows / 2),
      C.placeElement(S, "center", e, t, i);
    var n = Math.abs(t);
  ...
  function _() {
    ...
    switch (M.gridpanel_grid_align) {
      ...
      case "left":
        e =
          M.gridpanel_padding_border_left +
          M.gridpanel_arrows_padding_hor +
          r.width;
        break;
      case "middle":
      case "center":
    ...
    var s = j.getElement();
    switch (
      (C.placeElement(s, e, M.gridpanel_padding_border_top),
      (a = j.getSize()),
      M.gridpanel_arrows_align_vert)
    ) {
      default:
      case "center":
      case "middle":
  ...
  function y() {
    0 == k.isHorType ? (1 == M.gridpanel_vertical_scroll ? h() : f()) : b(),
      A.placeElements();
  }
  var w,
    T,
...
function UGThumbsGrid() {
  function e(e, t, i) {
    if (
      ((H = e.getObjects()),
      (F = e),
      F.attachThumbsPanel("grid", B),
      (L = jQuery(e)),
      (N = H.g_objWrapper),
      (D = H.g_arrItems),
      i === !0 && (V.isTilesMode = !0),
      (V.numThumbs = D.length),
      c(t),
      1 == V.isTilesMode)
    ) {
      X.setFixedMode(), X.setApproveClickFunction(P), X.init(e, U);
      var n = X.getOptions();
      (V.tileMaxHeight = n.tile_height),
        (V.tileMaxWidth = n.tile_width),
        (Y = X.getObjThumbs());
  ...
  function r() {
    ...
    if ((n(), 1 == V.isFirstTimeRun))
      k(),
        1 == V.isTilesMode
          ? (s(), u(), X.run())
          : (Y.setHtmlProperties(), u(), Y.loadThumbsImages());
    ...
    null != e && d(e.index),
      W.trigger(B.events.PANE_CHANGE, V.currentPane),
      (V.isFirstTimeRun = !1);
  }
  function a() {
  ...
  function s() {
    ...
    1 == t
      ? ((V.spaceBetweenCols = U.grid_space_between_mobile),
        (V.spaceBetweenRows = U.grid_space_between_mobile))
    ...
    return (
      o < U.grid_min_cols &&
        (s = Q.getItemSizeInSpace(
          V.gridWidth,
          U.grid_min_cols,
          V.spaceBetweenCols
        )),
      X.setTileSizeOptions(s),
      s != r && (e = !0),
      e
    );
  }
  function o() {
    var e = a(),
      ...
      n =
        U.grid_num_rows * t +
        (U.grid_num_rows - 1) * V.spaceBetweenRows +
        2 * U.grid_padding;
    (V.gridHeight = n),
      Q.setElementSize(R, i, n),
      Q.setElementSize(G, i, n),
      (V.innerWidth = i),
      (V.innerHeight = n);
  }
  function l() {
    var e = a(),
      ...
      i =
        U.grid_num_cols * t +
        (U.grid_num_cols - 1) * V.spaceBetweenCols +
        2 * U.grid_padding,
      n = V.gridHeight;
    (V.gridWidth = i),
      Q.setElementSize(R, i, n),
  ...
  function c(e) {
    (U = jQuery.extend(U, e)),
      ...
      (V.isNavigationVertical =
        "top" == U.grid_panes_direction || "bottom" == U.grid_panes_direction),
      (V.spaceBetweenCols = U.grid_space_between_cols),
      (V.spaceBetweenRows = U.grid_space_between_rows);
  }
  function g() {
    ...
    for (i = 0; i < l; i++) {
      ...
      p > V.innerWidth && (V.innerWidth = p),
        ...
        r++,
        r >= U.grid_num_cols &&
          ((n += c + V.spaceBetweenRows), (t = a), (r = 0)),
        1 == V.numPanes && V.numThumbsInPane++,
        n + c > V.gridHeight &&
          ((n = 0),
          (a = V.innerWidth + V.spaceBetweenCols),
          (t = a),
          (r = 0),
          1 == V.isMaxHeight &&
            1 == V.numPanes &&
            ((V.gridHeight = o), R.height(V.gridHeight)),
          i < l - 1 && (V.numPanes++, V.arrPanes.push(a)));
    }
    G.width(V.innerWidth),
      1 == V.isMaxHeight &&
        1 == V.numPanes &&
        ((V.gridHeight = o), R.height(o));
  }
  function p() {
    var e = G.children(".ug-thumb-wrapper"),
      t = 0,
    ...
    for (i = 0; i < l; i++) {
      ...
      g > r && (r = g),
        a++,
        a >= U.grid_num_cols &&
          ((n += c + V.spaceBetweenRows), (t = s), (a = 0)),
        1 == V.numPanes && V.numThumbsInPane++,
        (g = n + c);
      ...
      g > p &&
        (1 == V.isMaxHeight &&
          1 == V.numPanes &&
          ((V.gridHeight = r), R.height(V.gridHeight), (p = V.gridHeight)),
        (n = p + V.spaceBetweenRows),
        (o = n),
        (s = 0),
        (t = s),
        (a = 0),
        i < l - 1 && (V.numPanes++, V.arrPanes.push(n)));
    }
    G.height(r),
      (V.innerHeight = r),
      1 == V.isMaxHeight &&
        1 == V.numPanes &&
        ((V.gridHeight = r), R.height(r));
  }
  function h() {
    var e = G.children(".ug-thumb-wrapper"),
      t = U.grid_padding,
    ...
    for (i = 0; i < c; i++) {
      ...
      a - t + p > V.gridWidth &&
        ...
        d >= U.grid_num_rows
          ? ((d = 0),
            ...
            (l = 0),
            1 == V.numPanes &&
              ((V.gridWidth = s + U.grid_padding),
              R.width(V.gridWidth),
              (V.gridHeight = u + U.grid_padding),
              R.height(V.gridHeight)),
            V.numPanes++,
            V.arrPanes.push(t - U.grid_padding))
      ...
      var m = s + p;
      m > V.innerWidth && (V.innerWidth = m),
        (a += p + V.spaceBetweenCols),
        1 == V.numPanes && V.numThumbsInPane++;
    }
  ...
  function P() {
    ...
    var e = Q.isApproveStoredEventClick(
      V.storedEventID,
      V.isNavigationVertical
    );
    return e;
  ...
  function M(e) {
    ...
    0 == U.grid_carousel && r > 0 && "prev" == a && (r /= 3),
      0 == U.grid_carousel &&
        -s > r &&
        "next" == a &&
        (r = t.startInnerPos + n / 3),
      v(r);
  }
  function z(e) {
    if (0 == V.touchActive) return !0;
    ...
    var i = x(),
      ...
      r = n > 0 ? "prev" : "next";
    "next" == r
      ? 0 == U.grid_carousel && B.isLastPane()
        ? y()
        : B.nextPane()
      : 0 == U.grid_carousel && B.isFirstPane()
      ? y()
      : B.prevPane();
  }
  function O() {
  ...
  function k() {
    ...
    R.bind("mousedown touchstart", j),
      jQuery("body").bind("mousemove touchmove", M),
      jQuery(window).add("body").bind("mouseup touchend", z);
  }
  var L,
    H,
    N,
  ...
  (this.destroy = function () {
    ...
    (this.prevPane = function () {
      var e = V.currentPane - 1;
      return (
        !(0 > e && ((e = V.numPanes - 1), 0 == U.grid_carousel)) &&
        void B.gotoPane(e, "prev")
      );
    }),
...
function UGTiles() {
  function e(e, i) {
    (g_objects = e.getObjects()),
      (ae = e),
      (K = jQuery(e)),
      ($ = g_objects.g_objWrapper),
      (ee = g_objects.g_arrItems),
      (de = jQuery.extend(de, i)),
      t(),
      oe.init(e, de),
      (le = oe.getObjThumbs());
  }
  function t() {
    de.tiles_min_columns < 1 && (de.tiles_min_columns = 1),
      0 != de.tiles_max_columns &&
        de.tiles_max_columns < de.tiles_min_columns &&
        (de.tiles_max_columns = de.tiles_min_columns);
  }
  function i(e) {
    if (!e)
  ...
  function n() {
    if (
      (J.addClass("ug-tiles-rest-mode"),
      (ce.isTransInited = !0),
      1 == de.tiles_enable_transition)
    ) {
      J.addClass("ug-tiles-transit");
      var e = oe.getOptions();
      1 == e.tile_enable_image_effect &&
        0 == e.tile_image_effect_reverse &&
        J.addClass("ug-tiles-transit-overlays"),
        (ce.isTransActive = !0);
    }
  }
  function r() {
  ...
  function a() {
    return (
      0 != ce.isTransInited &&
      (J.addClass("ug-tiles-transition-active"),
      J.removeClass("ug-tiles-rest-mode"),
      0 != ce.isTransActive && void oe.disableEvents())
    );
  }
  function s() {
    return (
      0 != ce.isTransInited &&
      (J.removeClass("ug-tiles-transition-active"),
      void J.addClass("ug-tiles-rest-mode"))
    );
  }
  function o() {
    1 == ce.isTransActive
  ...
  function l() {
    (ue.colWidth = (ue.availWidth - ue.colGap * (ue.numCols - 1)) / ue.numCols),
      (ue.colWidth = Math.floor(ue.colWidth)),
      (ue.totalWidth = se.getSpaceByNumItems(
        ue.numCols,
        ue.colWidth,
        ue.colGap
      ));
  ...
  function u() {
    if (
      ...
      0 == ae.isMobileMode()
        ? (ue.colGap = de.tiles_space_between_cols)
        : (ue.colGap = de.tiles_space_between_cols_mobile),
      (ue.galleryWidth = r()),
      (ue.availWidth = ue.galleryWidth),
      1 == de.tiles_include_padding &&
        (ue.availWidth = ue.galleryWidth - 2 * ue.colGap),
      1 == de.tiles_exact_width)
    )
      (ue.numCols = se.getNumItemsInSpace(
        ue.availWidth,
        ue.colWidth,
        ue.colGap
      )),
        ue.maxCols > 0 && ue.numCols > ue.maxCols && (ue.numCols = ue.maxCols),
        ue.numCols < ue.minCols
          ? ((ue.numCols = ue.minCols), l())
          : (ue.totalWidth =
      ...
      e < ue.minCols
        ? (e = ue.minCols)
        : 0 != ue.maxCols && e > ue.maxCols && (e = ue.maxCols),
        (ue.numCols = e),
        l();
    }
  ...
  function g(e, t, i, n) {
    ...
    if (null === a) {
      if (1 == de.tiles_enable_transition)
    ...
    var l = r + a;
    (ue.colHeights[n] = l + ue.colGap),
      ue.maxColHeight < l && (ue.maxColHeight = l),
      1 == t && e.show().fadeTo(0, 1),
      1 == i && J.height(ue.maxColHeight);
  }
  function p(e) {
    e || (e = !1), u(), d();
    ...
    for (var i = 0; i < t.length; i++) {
      var n = jQuery(t[i]),
        r = void 0;
      1 == de.tiles_keep_order && (r = se.getColByIndex(ue.numCols, i)),
        g(n, e, !1, r);
    }
    o();
    var s = J.height();
  ...
  function f(e, t) {
    ...
    le.triggerImageLoadedEvent(i, e),
      1 == de.tiles_keep_order
        ? m(i)
        : (oe.resizeTile(i, ue.colWidth), g(i, !0, !0));
  }
  function _() {
    ...
    if (((ce.isAllLoaded = !1), 1 == ce.isFirstPlaced)) {
      ...
      if (
        1 == de.tiles_set_initial_height &&
        0 == se.isScrollbarExists() &&
        25 > t
      ) {
    ...
    se.checkImagesLoaded(
      ...
      function () {
        u(),
          (s != ue.numCols || o != ue.galleryWidth) && p(!1),
          n(),
          re.trigger(ne.events.ALL_TILES_LOADED);
      },
      function (e, t) {
        1 == ce.isFirstPlaced && ae.triggerEvent(ne.events.TILES_FIRST_PLACED),
          f(e, t);
      }
    );
  }
  function v() {
    ...
    jQuery.each(t, function (e, t) {
      ...
      var r = le.getItemByThumb(t),
        s = r.thumbWidth,
        o = r.thumbHeight;
      o !== i && (s = Math.floor(r.thumbRatioByWidth * i)),
        (n[e] = s),
        (a += s);
    });
    var l = Math.ceil(a / e);
    ...
    jQuery.each(d, function (t, r) {
      ...
      jQuery.each(c, function (e, t) {
        return (
          0 != h &&
          (0 > h ? ((c[e] = t + 1), h++) : ((c[e] = t - 1), h--),
          void (e == c.length - 1 && 0 != h && (c[e] -= h)))
        );
      }),
        (f[t] = c);
    });
    ...
    jQuery.each(i.arrRows, function (t, n) {
      ...
      jQuery.each(n, function (t, n) {
        var u = jQuery(n),
          d = a,
          c = r[t];
        oe.resizeTile(u, c, d, oe.resizemode.VISIBLE_ELEMENTS),
          se.placeElement(u, o, s),
          (o += c),
          o > l && (l = o),
          (o += i.gap),
          1 == e && jQuery(n).show();
      ...
      se.checkImagesLoaded(
        ...
        function () {
          setTimeout(function () {
            b(!0),
              t.fadeTo(0, 1),
              ae.triggerEvent(ne.events.TILES_FIRST_PLACED),
              n(),
              re.trigger(ne.events.ALL_TILES_LOADED);
          });
        },
  ...
  function T() {
    ...
    (ge.galleryWidth = e),
      ...
      1 == ae.isMobileMode() &&
        (ge.currentGap = de.tiles_space_between_cols_mobile),
      null == ge.colWidth
    ...
    switch (
      ...
      ge.optimalTileWidth > ge.colWidth
        ...
        : (ge.nestedOptimalCols = 1),
      (ge.totalWidth =
        ge.maxColumns * (ge.colWidth + ge.currentGap) - ge.currentGap),
      de.tiles_align)
    ) {
      case "center":
      default:
  ...
  function S(e) {
    var t,
      ...
      o = e.index(),
      l = Math.ceil(
        I(o) * ((1 * ge.nestedOptimalCols) / 3) + (2 * ge.nestedOptimalCols) / 3
      ),
      u = s.width,
      d = s.height,
      c = u / d;
    return (
      u > d
        ? ((t = l), (i = Math.round(t / c)), 0 == i && (i = 1))
        : ((i = l), (t = Math.round(i * c)), 0 == t && (t = 1)),
      (n.dimWidth = t),
      (n.dimHeight = i),
      (n.width = t * r + a * (t - 1)),
      (n.height = i * r + a * (i - 1)),
  ...
  function P(e) {
    if (1 == de.tiles_nested_debug)
      return "undefined" == typeof e && (e = !0), E(!0, e), !1;
  ...
  function j(e, t, i) {
    ...
    if (
      ge.columnsValueToEnableHeightResize <= l[0] &&
      ge.maxColumns >= 2 * ge.nestedOptimalCols
    ) {
      var u = L(i, n),
        d = N(e, u.newHeight, !0);
      ...
      var c = O(l, d.dimWidth, i),
        ...
        p = !1;
      g >= 2 && (p = !0),
        u.newHeight >= n.dimHeight && (n = N(e, u.newHeight, !0));
  ...
  function A(e) {
    for (var t = 0, i = 0, n = 0; n < e.length - 1; n++) {
      var r = e[n].sizes,
        ...
        s = -1;
      B(r.top + r.dimHeight) &&
        ge.maxColumns > r.left + r.dimWidth &&
        ((a = te[r.top + r.dimHeight - 1][r.left + r.dimWidth]),
        (s = te[r.top + r.dimHeight][r.left + r.dimWidth])),
        a != s && t++;
    }
    for (var n = 0; n < e.length - 1; n++) {
      ...
      B(r.top + r.dimHeight) &&
        r.left - 1 >= 0 &&
        ((a = te[r.top + r.dimHeight - 1][r.left - 1]),
        (s = te[r.top + r.dimHeight][r.left - 1])),
        a != s && i++;
    }
    return Math.max(i, t);
  }
  function M(e, t, i) {
    var n = ie[e],
      ...
      s = n.top,
      o =
        (parseInt(s / (ge.colWidth + ge.currentGap)),
        parseInt(a / (ge.colWidth + ge.currentGap)),
        r - t + i),
      l = N(e, o, !0),
      u = [];
  ...
  function O(e, t) {
    ...
    for (var c = n, g = [], o = r.length - 1; o >= 0; o--) {
      ...
      0 != o
        ? ((p = Math.max(
            Math.round((1 * n) / 3),
            Math.floor(r[o][1] * (n / i))
          )),
          (c -= p),
          (d = N(l, p, !0)),
          (d.left = a),
          (d.top = s),
          g.push({ tileID: l, sizes: d }),
          (s += d.dimHeight))
        : ((p = c),
          (d = N(l, p, !0)),
          (d.left = a),
  ...
  function k(e, t, i) {
    ...
    if ((o.push(e), n >= 0)) {
      for (a = 0; n >= 0; ) {
        if (
          ((r = te[n][i]),
          ("undefined" != typeof te[n][i - 1] && te[n][i - 1] == te[n][i]) ||
            ("undefined" != typeof te[n][i + t] &&
              te[n][i + t - 1] == te[n][i + t]) ||
            te[n][i] != te[n][i + t - 1])
        )
  ...
  function L(e, t) {
    ...
    if (
      "undefined" == typeof l[ge.gridY] ||
      "undefined" == typeof l[ge.gridY][e - 1]
    )
      n = 0;
    else
      for (
        var u = 0;
        "undefined" != typeof te[ge.gridY + u] && -1 != te[ge.gridY + u][e - 1];

      )
        (s = te[ge.gridY + u][e - 2]), u++, n++;
    if (
      "undefined" == typeof l[ge.gridY] ||
      "undefined" == typeof l[ge.gridY][e + r]
    )
      i = 0;
    else
      for (
        u = 0;
        "undefined" != typeof te[ge.gridY + u] && -1 != te[ge.gridY + u][e + r];

      )
        (o = te[ge.gridY + u][e + r + 1]), u++, i++;
    var d = 0,
      c = 0;
    Math.abs(a - n) < Math.abs(a - i) && 0 != n
      ? ((d = n), (c = s))
      : 0 != i
      ? ((d = i), (c = o))
      : (d = a);
  ...
  function H(e, t, i) {
    ...
    if (((dimWidth = t), (dimHeight = Math.round(dimWidth / l)), 1 == i)) {
      ...
      return (
        (u.dimWidth = dimWidth),
        (u.dimHeight = dimHeight),
        (u.width = dimWidth * n + r * (dimWidth - 1)),
        (u.height = dimHeight * n + r * (dimHeight - 1)),
        u
      );
    }
    (a.dimWidth = dimWidth),
      (a.dimHeight = dimHeight),
      (a.width = dimWidth * n + r * (dimWidth - 1)),
      (a.height = dimHeight * n + r * (dimHeight - 1));
  }
  function N(e, t, i) {
    i || (i = !1);
    var n = ie[e],
  ...
  function D(e) {
    for (var t = 0, i = 0, n = 0; n < e.length; n++) {
      ...
      (resizeVal = r.dimWidth / r.dimHeight / (r.imgWidth / r.imgHeight)),
        resizeVal < 1 && (resizeVal = 1 / resizeVal),
        (t += resizeVal),
        i++;
    }
    return t / i;
  ...
  function W(e, t, i, n) {
    for (var r = 0; r < t.dimHeight; r++)
      for (var a = 0; a < t.dimWidth; a++)
        0 == B(n + r) && F(n + r), Y(n + r, i + a, e);
  }
  function F(e) {
    te[e] = new Object();
  ...
  function U(e, t) {
    ...
    oe.resizeTile(i, n.width, n.height, oe.resizemode.VISIBLE_ELEMENTS),
      se.placeElement(i, a, r),
      r + n.height > ge.maxColHeight && (ge.maxColHeight = r + n.height),
      1 == t && i.fadeTo(0, 1);
  }
  function V() {
  ...
  function Z() {
    switch (
      ($.children(".ug-tile").show(),
      1 == ce.isFirstTimeRun && q(),
      oe.run(),
      de.tiles_type)
    ) {
      default:
  ...
  (this.destroy = function () {
    K.off(ae.events.SIZE_CHANGE),
      oe.destroy(),
      K.off(ne.events.TILES_FIRST_PLACED);
  }),
    (this.init = function (t, i) {
      e(t, i);
    }),
    ...
    (this.runNewItems = function () {
      ...
      switch ((oe.setHtml(J, !0), oe.run(!0), de.tiles_type)) {
        ...
        case "nested":
          throw new Error(
            "Tiles type: " + de.tiles_type + " not support load more yet"
          );
      }
    });
}
function UGTileDesign() {
  function e(e, i) {
    ...
    var o = W.getOptions();
    (F = jQuery.extend(F, o)),
      (Y.ratioByWidth = F.tile_width / F.tile_height),
      (Y.ratioByHeight = F.tile_height / F.tile_width),
      F.tile_size_by == D.sizeby.GLOBAL_RATIO &&
        Y.isTextpanelOutside &&
        (Y.hasImageContainer = !0);
  }
  function t() {
    if (
      (1 == F.tile_enable_overlay
        ? ((F.thumb_overlay_opacity = F.tile_overlay_opacity),
          (F.thumb_overlay_color = F.tile_overlay_color))
        : 0 == F.tile_enable_icons
        ? (F.thumb_color_overlay_effect = !1)
        : (F.thumb_overlay_opacity = 0),
      F.tile_as_link &&
        ((F.thumb_wrapper_as_link = !0),
        (F.thumb_link_newpage = F.tile_link_newpage)),
      1 == F.tile_enable_outline &&
        0 == F.tile_enable_border &&
        (F.tile_enable_outline = !1),
      (Y.tileInnerReduce = 0),
      F.tile_enable_border &&
        ((Y.tileInnerReduce = 2 * F.tile_border_width),
        W.setThumbInnerReduce(Y.tileInnerReduce)),
      ...
      switch (F.tile_textpanel_position) {
        ...
        case "bottom":
          (Y.isTextpanelOutside = !0),
            (F.tile_textpanel_always_on = !0),
            (F.tile_textpanel_offset = 0);
          break;
        case "inside_top":
          F.tile_textpanel_align = "top";
          break;
        case "middle":
          (F.tile_textpanel_align = "middle"),
            (F.tile_textpanel_appear_type = "fade");
      }
      0 == F.tile_textpanel_always_on && (Y.isSaparateIcons = !0);
    }
    0 != F.tile_textpanel_offset &&
      ((F.tile_textpanel_appear_type = "fade"),
      (F.tile_textpanel_margin = F.tile_textpanel_offset)),
      "title_and_desc" == F.tile_textpanel_source &&
        ((F.tile_textpanel_enable_description = !0),
        (F.tile_textpanel_desc_style_as_title = !0));
  }
  function i() {
    var e = G.isMobileMode();
    switch (
      ((Y.isTextPanelHidden = !1),
      1 == e && 0 == F.tile_textpanel_always_on && (Y.isTextPanelHidden = !0),
      (Y.isVideoplayIconAlwaysOn = F.tile_videoplay_icon_always_on),
      F.tile_videoplay_icon_always_on)
    ) {
      case "always":
  ...
  function n(e, t) {
    ...
    var i = "";
    1 == Y.hasImageContainer &&
      (i += "<div class='ug-image-container ug-trans-enabled'>");
    var n = "ug-thumb-image";
    (0 == F.tile_enable_image_effect || 1 == F.tile_image_effect_reverse) &&
      (n += " ug-trans-enabled");
    var r = B.stripTags(t.title);
    (r = B.htmlentitles(r)),
      (i +=
        '<img src="' +
        B.escapeDoubleSlash(t.urlThumb) +
        "\" alt='" +
        r +
        "' class='" +
        n +
    ...
    var a = {};
    if (
      (1 == F.tile_enable_background &&
        (a["background-color"] = F.tile_background_color),
      1 == F.tile_enable_border &&
        ((a["border-width"] = F.tile_border_width + "px"),
        (a["border-style"] = "solid"),
        (a["border-color"] = F.tile_border_color),
        F.tile_border_radius &&
          (a["border-radius"] = F.tile_border_radius + "px")),
      1 == F.tile_enable_outline &&
        (a.outline = "1px solid " + F.tile_outline_color),
      1 == F.tile_enable_shadow)
    ) {
      var s = F.tile_shadow_h + "px ";
      (s += F.tile_shadow_v + "px "),
        (s += F.tile_shadow_blur + "px "),
        (s += F.tile_shadow_spread + "px "),
        (s += F.tile_shadow_color),
        (a["box-shadow"] = s);
    }
    e.css(a);
    var o = "";
    if (F.tile_enable_icons) {
      if (0 == F.tile_as_link && 1 == F.tile_enable_action) {
        ...
        "image" != t.type && (l = "ug-button-play ug-icon-play"),
          (o +=
            "<div class='ug-tile-icon " + l + "' style='display:none'></div>");
      }
      if ((t.link && 1 == F.tile_show_link_icon) || 1 == F.tile_as_link)
        if (0 == F.tile_as_link) {
          var u = "";
          1 == F.tile_link_newpage && (u = " target='_blank'"),
            (o +=
              "<a href='" +
              t.link +
              "'" +
      ...
      0 == h.length ? (h = null) : h.hide(),
        h || 1 != F.tile_enable_action || e.addClass("ug-tile-clickable");
    ...
    if (1 == F.tile_enable_textpanel) {
      ...
      v.init(G, F, "tile");
      var b = "";
      (1 == F.tile_textpanel_always_on || 1 == Y.isTextpanelOutside) &&
        (b = "ug-trans-enabled"),
        v.appendHTML(e, b);
      var y = t.title,
        w = "";
      ...
      if (
        (v.setTextPlain(y, w),
        0 == F.tile_textpanel_always_on && v.getElement().fadeTo(0, 0),
        e.data("objTextPanel", v),
        1 == F.tile_textpanel_always_on)
      ) {
        var T = d(e);
        T.css("z-index", 2);
      }
  ...
  function b(e, t, i, n) {
    ...
    if (1 == Y.isTextpanelOutside) {
      ...
      if (
        ((i -= c),
        "top" == F.tile_textpanel_position && (d = c),
        1 == Y.hasImageContainer)
      ) {
        var p = s(e);
    ...
    if (0 == F.tile_enable_image_effect)
      B.scaleImageCoverParent(l, t, i),
        0 == Y.hasImageContainer && null !== d && B.placeElement(l, 0, d);
    else {
      var h = "nothing";
      n === !0 &&
        0 == Y.isTextpanelOutside &&
        (h = 1 == F.tile_image_effect_reverse ? "effect" : "image"),
        "effect" != h &&
          (B.setElementSize(a, t, i),
          null !== d && B.placeElement(a, 0, d),
          B.scaleImageCoverParent(u, t, i)),
        "image" != h &&
          (1 == Y.hasImageContainer
            ? B.scaleImageCoverParent(l, t, i)
            : "effect" == h
            ? (B.scaleImageCoverParent(l, t, i),
              null !== d && B.placeElement(l, 0, d))
            : B.cloneElementSizeAndPos(u, l, !1, null, d));
    }
  }
  function y(e, t, i, n) {
    var r = null;
    if (
      (i && (r = i - Y.tileInnerReduce),
    ...
    var c =
      1 == F.tile_textpanel_always_on || "fade" == F.tile_textpanel_appear_type;
    if (c)
      if (
        1 == Y.isTextpanelOutside &&
        n &&
        "bottom" == F.tile_textpanel_position
      ) {
        var p = n - d;
        o.positionPanel(p);
  ...
  function w(e) {
    ...
    if (t && i) {
      ...
      w > x &&
        ((w = Math.floor((n.width - _.width - v.width) / 3)),
        (T = _.width + w + v.width),
        (x = Math.floor((n.width - T) / 2))),
        B.placeElement(t, x, "middle", 0, c),
        B.placeElement(i, x + _.width + w, "middle", 0, c);
    } else
      t && B.placeElement(t, "center", "middle", 0, c),
        i && B.placeElement(i, "center", "middle", 0, c);
    t && t.show(), i && i.show();
  }
  function T(e, t) {
  ...
  function x(e, t) {
    ...
    if ("slide" == F.tile_textpanel_appear_type) {
      ...
      var a = -r.height,
        ...
        l = {},
        u = "bottom";
      "inside_top" == F.tile_textpanel_position && (u = "top"),
        (o[u] = a + "px"),
        (l[u] = s + "px"),
        1 == t
          ? (n.fadeTo(0, 1),
            0 == n.is(":animated") && n.css(o),
            (l.opacity = 1),
            n.stop(!0).animate(l, i))
          : n.stop(!0).animate(o, i);
  ...
  function I(e, t) {
    if (
      ((t = jQuery(t)),
      F.tile_enable_image_effect && T(t, !0),
      1 == F.tile_enable_textpanel &&
        0 == F.tile_textpanel_always_on &&
        0 == Y.isTextPanelHidden &&
        x(t, !0),
      Y.isSaparateIcons && 1 == F.tile_enable_icons)
    ) {
  ...
  function E(e, t) {
    if (
      ((t = jQuery(t)),
      F.tile_enable_image_effect && T(t, !1),
      1 == F.tile_enable_textpanel &&
        0 == F.tile_textpanel_always_on &&
        x(t, !1),
      1 == Y.isSaparateIcons && 1 == F.tile_enable_icons)
    ) {
      var i = 1 != F.thumb_overlay_reverse,
        n = D.getItemByTile(t);
  ...
  function C(e, t, i) {
    return (
      (t = jQuery(t)),
      (1 == F.tile_visible_before_image &&
        t.data("image_placed") !== !0 &&
        i !== !0) ||
        (w(t), void W.setThumbNormalStyle(t))
    );
  }
  function j(e, t, i) {
  ...
  function A(e) {
    return 1 == _(e)
      ? (R.trigger(D.events.TILE_CLICK, e), !0)
      : void (0 == f(e) && (P(e), W.setThumbOverStyle(e)));
  }
  function M(e) {
    var t = jQuery(this),
      ...
      n = !0;
    if (
      (Y.funcParentApproveClick && 0 == Y.funcParentApproveClick() && (n = !1),
      "a" == i)
    )
  ...
  function z(e) {
    ...
    var t = jQuery(this).parents(".ug-tile"),
      i = !0;
    return (
      Y.funcParentApproveClick && 0 == Y.funcParentApproveClick() && (i = !1),
      0 == f(t)
        ? (A(t), !0)
        : 1 == i
        ? (R.trigger(D.events.TILE_CLICK, t), !1)
        : void 0
    );
  }
  function O(e) {
    var t = jQuery(this).parents(".ug-tile");
    Y.funcParentApproveClick &&
      0 == Y.funcParentApproveClick() &&
      e.preventDefault(),
      0 == f(t) && 0 == F.tile_as_link && (e.preventDefault(), A(t));
  }
  var k,
    L,
    H,
  ...
  (this.loadTileImage = function (e) {
    ...
    (this.setTileSizeOptions = function (e) {
      if (F.tile_size_by !== D.sizeby.GLOBAL_RATIO)
    ...
    (this.run = function (e) {
      ...
      var i = W.getThumbs(t);
      F.tile_size_by == D.sizeby.GLOBAL_RATIO &&
        D.resizeAllTiles(F.tile_width, D.resizemode.WRAPPER_ONLY, i),
        1 == F.tile_enable_image_effect &&
          0 == F.tile_image_effect_reverse &&
          i.children(".ug-thumb-image").fadeTo(0, 0),
        W.setHtmlProperties(i),
        1 == F.tile_visible_before_image &&
          (i.children(".ug-thumb-image").fadeTo(0, 0), W.loadThumbsImages());
    }),
    ...
    (this.getTileHeightByWidth = function (e, t) {
      ...
      return (
        t &&
          1 == Y.isTextpanelOutside &&
          F.tile_size_by == D.sizeby.IMAGE_RATIO &&
          (n += g(t)),
        n
      );
    }),
...
function UGAviaControl() {
  ...
  function r() {
    ...
    1 > i ? (t = i) : ((t = i / 4), t > 0 && 1 > t && (t = 1)),
      f.strip_finalPos < e && (t *= -1);
    var n = e + t;
  ...
  function a() {
    return (
      1 != f.isStripMoving &&
      ((f.isStripMoving = !0), void (f.handle_timeout = setInterval(r, 10)))
    );
  }
  function s() {
    return (
      0 != f.isStripMoving &&
      ((f.isStripMoving = !1),
      void (f.handle_timeout = clearInterval(f.handle_timeout)))
    );
  }
  function o(e) {
    return 0 == m ? n(e) : i(e);
  ...
  function l(e) {
    var t = o(e);
    return (
      null !== t && ((f.is_strip_moving = !0), (f.strip_finalPos = t), void a())
    );
  }
  var u,
    d,
...
function UGSlider() {
  function e(e, t, n) {
    (_e = e),
      n && ((he = n), (t = Te.convertCustomPrefixOptions(t, he, "slider"))),
      (te = jQuery(e));
    var r = _e.getObjects();
    if (
      ((ie = r.g_objWrapper),
      ...
      t.hasOwnProperty("slider_progress_indicator_type") &&
        (Ie.slider_progress_indicator_type = t.slider_progress_indicator_type),
      "bar" == Ie.slider_progress_indicator_type &&
        (Ie = jQuery.extend(Ie, Ee)),
      t && me.setOptions(t),
      i(),
    ...
    Ie.slider_enable_text_panel &&
      ((Se = new UGTextPanel()), Se.init(_e, Ie, "slider")),
      Ie.slider_enable_zoom_panel &&
        ((pe = new UGZoomButtonsPanel()), pe.init(me, Ie));
  ...
  function t() {
    ...
    if (((Pe.isRunOnce = !0), Ie.slider_background_color)) {
      ...
      1 != Ie.slider_background_opacity &&
        (e = Te.convertHexToRGB(e, Ie.slider_background_opacity)),
        re.css("background-color", e);
    } else
      1 != Ie.slider_background_opacity &&
        ((e = Te.convertHexToRGB("#000000", Ie.slider_background_opacity)),
        re.css("background-color", e));
    1 == Ie.slider_control_swipe &&
      ((ce = new UGTouchSliderControl()), ce.init(me, Ie)),
      1 == Ie.slider_control_zoom &&
        ((ge = new UGZoomSliderControl()), ge.init(me, Ie)),
      Se && Se.run(),
      V();
  }
  function i() {
    ...
    "" == Ie.slider_bullets_skin && (Ie.slider_bullets_skin = t),
      ...
      "" == Ie.slider_fullscreen_button_skin &&
        (Ie.slider_fullscreen_button_skin = t),
    ...
    if (
      ...
      1 == Ie.slider_enable_arrows &&
        ...
        (i +=
          ...
          Ie.slider_arrows_skin +
          "'></div>")),
      1 == Ie.slider_enable_play_button &&
        (i +=
          "<div class='ug-slider-control ug-button-play ug-skin-" +
          Ie.slider_play_button_skin +
          "'></div>"),
      1 == Ie.slider_enable_fullscreen_button &&
        (i +=
      ...
      ye && ye.appendHTML(re),
      1 == Ie.slider_enable_arrows &&
        ((ue = re.children(".ug-arrow-left")),
        (de = re.children(".ug-arrow-right"))),
      1 == Ie.slider_enable_play_button &&
        (ve = re.children(".ug-button-play")),
      1 == Ie.slider_enable_fullscreen_button &&
        (be = re.children(".ug-button-fullscreen")),
      1 == Ie.slider_enable_progress_indicator)
    ) {
      xe = Te.initProgressIndicator(Ie.slider_progress_indicator_type, Ie, re);
      var r = xe.getType();
      "bar" == r &&
        "pie" == Ie.slider_progress_indicator_type &&
        ((Ie.slider_progress_indicator_type = "bar"),
        (Ie = jQuery.extend(Ie, Ee))),
        _e.setProgressIndicator(xe);
    }
    if (
      1 == Ie.slider_enable_text_panel &&
      (Se.appendHTML(re), 0 == Ie.slider_textpanel_always_on)
    ) {
      var a = Se.getElement();
  ...
  function s() {
    if (
      (ye &&
        ...
        Te.placeElement(
          objBullets,
          Ie.slider_bullets_align_hor,
          Ie.slider_bullets_align_vert,
          Ie.slider_bullets_offset_hor,
          Ie.slider_bullets_offset_vert
        ),
        Te.placeElement(
          objBullets,
          Ie.slider_bullets_align_hor,
      ...
      1 == Ie.slider_enable_arrows &&
        (Te.placeElement(
          ue,
          Ie.slider_arrow_left_align_hor,
          Ie.slider_arrow_left_align_vert,
          Ie.slider_arrow_left_offset_hor,
          Ie.slider_arrow_left_offset_vert
        ),
        Te.placeElement(
          de,
          Ie.slider_arrow_right_align_hor,
          Ie.slider_arrow_left_align_vert,
          Ie.slider_arrow_right_offset_hor,
          Ie.slider_arrow_right_offset_vert
        )),
      ...
      if ("bar" == Ie.slider_progress_indicator_type) {
        ...
        xe.setSize(t),
          Te.placeElement(
            e,
            "left",
            Ie.slider_progress_indicator_align_vert,
            0,
            Ie.slider_progress_indicator_offset_vert
          );
      } else
        Te.placeElement(
          e,
          Ie.slider_progress_indicator_align_hor,
          Ie.slider_progress_indicator_align_vert,
          Ie.slider_progress_indicator_offset_hor,
          Ie.slider_progress_indicator_offset_vert
        );
    }
  ...
  function o() {
    if (
      (ve &&
        Te.placeElement(
          ve,
          Ie.slider_play_button_align_hor,
          Ie.slider_play_button_align_vert,
          Ie.slider_play_button_offset_hor,
          Ie.slider_play_button_offset_vert
        ),
      be &&
        Te.placeElement(
          be,
          Ie.slider_fullscreen_button_align_hor,
          Ie.slider_fullscreen_button_align_vert,
          Ie.slider_fullscreen_button_offset_hor,
          Ie.slider_fullscreen_button_offset_vert
        ),
      pe)
    ) {
      var e = pe.getElement();
      Te.placeElement(
        e,
        Ie.slider_zoompanel_align_hor,
        Ie.slider_zoompanel_align_vert,
        Ie.slider_zoompanel_offset_hor,
  ...
  function l() {
    ...
    (i = me.isSlideHasItem(r.objNextSlide)),
      ...
      n
        ? ((o = r.objPrevSlide.outerWidth()), r.objPrevSlide.css("z-index", 1))
        : r.objPrevSlide.hide(),
      (t = o + r.objCurrentSlide.outerWidth()),
      (e = t),
      i
        ? ((e = t + r.objNextSlide.outerWidth()),
          r.objPrevSlide.css("z-index", 2))
        : r.objNextSlide.hide(),
      r.objCurrentSlide.css("z-index", 3),
      Te.placeElement(r.objCurrentSlide, o, a),
      ae.css({ left: -o + "px", width: e + "px" }),
      n &&
        (Te.placeElement(r.objPrevSlide, s, a), Te.showElement(r.objPrevSlide)),
      i &&
        (Te.showElement(r.objNextSlide), Te.placeElement(r.objNextSlide, t, a));
  }
  function u(e) {
    var t = e.data("index");
  ...
  function g(e, t) {
    ...
    if (
      (t &&
        (t.hasOwnProperty("imageWidth") && (r = t.imageWidth),
        t.hasOwnProperty("imageHeight") && (a = t.imageHeight)),
      0 >= r)
    )
      return i;
    var s = a > r ? r : a,
  ...
  function p(e, t, i) {
    ...
    if (1 == Ie.slider_image_border) {
      ...
      var r = g(e, i);
      (n["border-width"] = r + "px"),
        (n["border-color"] = Ie.slider_image_border_color),
        (n["border-radius"] = Ie.slider_image_border_radius);
    }
    "image" != t &&
      1 == Ie.slider_video_constantsize &&
      (n["background-color"] = "#000000"),
      1 == Ie.slider_image_shadow &&
  ...
  function m(e, t, i) {
    ...
    if (((objPadding = me.getObjImagePadding()), s == a && i !== !0)) {
      ...
      var g = {};
      (g =
        "image" != l && 1 == Ie.slider_video_constantsize
          ? h(u, t)
          : Te.scaleImageFitParent(
              u,
              t.imageWidth,
              t.imageHeight,
              o,
        ...
        p(u, l, g),
        fe.trigger(me.events.AFTER_PUT_IMAGE, e);
    } else if (
      ((u = Te.placeImageInsideParent(
        a,
        n,
        t.imageWidth,
        t.imageHeight,
      ...
      if (
        ...
        var g = Te.getImageInsideParentData(
          n,
          t.imageWidth,
          t.imageHeight,
          o,
      ...
      u.fadeTo(0, 0),
        ...
        u.on("load", function () {
          ...
          c(r),
            i.data("isLoading", !1),
            me.isSlideCurrent(i) && fe.trigger(me.events.CURRENTSLIDE_LOAD_END),
            _e.onItemBigImageLoaded(null, e);
          var o = _e.getItem(t),
            l = {};
          "image" != n && 1 == Ie.slider_video_constantsize
            ? h(e, o)
            : (l = Te.scaleImageFitParent(
                e,
                o.imageWidth,
                o.imageHeight,
                s,
            ...
            e.fadeTo(0, 1),
            p(e, n, l),
            fe.trigger(me.events.AFTER_PUT_IMAGE, i);
        });
  }
  function f(e, t) {
    try {
      ...
      if (null == t)
        return (
          ...
          e.removeData("index"),
          e.removeData("type"),
          e.removeData("urlImage"),
          !1
        );
      e.data("index"),
        e.data("index", t.index),
        e.data("type", t.type),
        1 == Ie.slider_enable_links &&
          "image" == t.type &&
          (t.link
      ...
      throw (
        ("undefined" != typeof e.fileName &&
          "showbig" == e.fileName &&
          _e.showErrorMessageReplaceGallery(e.message),
        i.html(""),
        new Error(e))
      );
    }
  ...
  function _() {
    ...
    var e = Se.getElement(),
      t = 0;
    (1 == Pe.isTextPanelSaparateHover || 1 == Ie.slider_textpanel_always_on) &&
      (t = Ie.slider_controls_appear_duration),
      e.stop().fadeTo(t, 0),
      e.data("isHidden", !0);
  }
  function v() {
  ...
  function w() {
    ...
    if (1 == Ie.slider_video_constantsize) {
      ...
      (n += Ie.slider_video_padding_left), (r += Ie.slider_video_padding_top);
    we.setPosition(n, r);
  }
  function T() {
  ...
  function I(e, t, i) {
    i
      ? e.fadeTo(Ie.slider_transition_speed, t, i)
      : e.fadeTo(Ie.slider_transition_speed, t);
  }
  function E(e, t, i) {
    if (!t) var t = !1;
    var n = me.getSlidesReference();
    ...
    if (
      ...
      n.objCurrentSlide.fadeTo(0, 0),
        ...
        me.placeNabourItems(),
        fe.trigger(me.events.TRANSITION_END),
        i !== !0 && we.hide();
    else {
      if (
  ...
  function P() {
    1 == Ie.slider_fullscreen_button_mobilehide && be && be.hide(),
      1 == Ie.slider_play_button_mobilehide && ve && ve.hide(),
      1 == Ie.slider_zoompanel_mobilehide && pe && pe.getElement().hide();
  }
  function C() {
    1 == Ie.slider_fullscreen_button_mobilehide && be && be.show(),
      1 == Ie.slider_play_button_mobilehide && ve && ve.show(),
      1 == Ie.slider_zoompanel_mobilehide && pe && pe.getElement().show();
  }
  function j() {
  ...
  function z(e) {
    ...
    e === !0
      ...
      : (t.stop().show().fadeTo(0, 0),
        t.fadeTo(Ie.slider_controls_appear_duration, 1)),
      (Pe.isControlsVisible = !0);
  }
  function O() {
  ...
  function L(e, t, i) {
    ...
    var r = n.index;
    ye && ye.setActive(r),
      Se && 0 == Pe.isTextPanelSaparateHover && v(),
      k("image" == n.type ? "image" : "video");
  }
  function H(e, t) {
    _e.selectItem(t);
  }
  function N(e) {
    return (
      !(!ce || 0 != ce.isTapEventOccured(e)) ||
      void fe.trigger(me.events.CLICK, e)
    );
  }
  function D() {
    var e = me.getCurrentSlide(),
    ...
    return t
      ...
      : void (
          ...
          (O(),
          Se &&
            1 == Ie.slider_textpanel_always_on &&
            me.isCurrentSlideType("image") &&
            me.isCurrentSlideImageFit() &&
            v())
        );
  }
  function R(e) {
  ...
  function Y(e, t, i) {
    se.data("index") == t && ((objItem = _e.getItem(t)), m(se, objItem, !0)),
      oe.data("index") == t && ((objItem = _e.getItem(t)), m(oe, objItem, !0)),
      le.data("index") == t && ((objItem = _e.getItem(t)), m(le, objItem, !0));
  }
  function X(e, t) {
    t = jQuery(t);
  ...
  function V() {
    te.on(_e.events.ITEM_IMAGE_UPDATED, Y),
      ...
      1 == Ie.slider_enable_arrows &&
        (Te.addClassOnHover(de, "ug-arrow-hover"),
        Te.addClassOnHover(ue, "ug-arrow-hover"),
        _e.setNextButton(de),
        _e.setPrevButton(ue)),
      ...
      be &&
        (Te.addClassOnHover(be, "ug-button-hover"),
        _e.setFullScreenToggleButton(be)),
  ...
  (this.switchSlideNums = function (e) {
    switch ((fe.trigger(me.events.BEFORE_SWITCH_SLIDES), e)) {
      case "left":
        var t = Pe.numCurrent;
        (Pe.numCurrent = Pe.numNext),
          (Pe.numNext = Pe.numPrev),
          (Pe.numPrev = t);
        break;
      case "right":
        var t = Pe.numCurrent;
        (Pe.numCurrent = Pe.numPrev),
          (Pe.numPrev = Pe.numNext),
          (Pe.numNext = t);
        break;
      default:
        throw new Error("wrong direction: " + e);
    ...
    (this.startSlideAction = function (e) {
      ...
      switch (
        (1 == Ie.slider_video_constantsize && T(), w(), we.show(), t.type)
      ) {
        case "youtube":
    ...
    (this.getScaleMode = function (e) {
      ...
      return "image" != t
        ? Ie.slider_scale_mode_media
        : Ie.slider_scale_mode == Ie.slider_scale_mode_fullscreen
        ? Ie.slider_scale_mode
        : 1 == _e.isFullScreen()
        ? Ie.slider_scale_mode_fullscreen
        : Ie.slider_scale_mode;
    }),
    (this.getObjects = function () {
      var e = {
    ...
    (this.setOptions = function (e) {
      he && (e = Te.convertCustomPrefixOptions(e, he, "slider")),
        (Ie = jQuery.extend(Ie, e));
    }),
    (this.setSize = function (e, t) {
      ...
      if ("image" != c && 1 == Ie.slider_video_constantsize) T();
        ...
        var g =
            e - Ie.slider_video_padding_left - Ie.slider_video_padding_right,
...
function UGTextPanel() {
  function e(e, t) {
    ...
    if ((c && (o = jQuery.trim(c.text())), "" != o)) {
      var l = i;
      d && (l += v.textpanel_padding_title_description),
        f.placeElement(c, 0, l);
  ...
  function t() {
    ...
    if ((d && (e += d.outerHeight()), c)) {
      var t = "";
      c && (t = jQuery.trim(c.text())),
        "" != t &&
          (d && (e += v.textpanel_padding_title_description),
          (e += c.outerHeight()));
    }
    return e;
  }
  ...
  function a() {
    ...
    if (1 == v.textpanel_enable_title) {
      ...
      null !== v.textpanel_title_color && (t.color = v.textpanel_title_color),
        null !== v.textpanel_title_font_family &&
          (t["font-family"] = v.textpanel_title_font_family),
        null !== v.textpanel_title_text_align &&
          (t["text-align"] = v.textpanel_title_text_align),
        null !== v.textpanel_title_font_size &&
          (t["font-size"] = v.textpanel_title_font_size + "px"),
        null !== v.textpanel_title_bold &&
          (v.textpanel_title_bold === !0
            ? (t["font-weight"] = "bold")
    ...
    if (1 == v.textpanel_enable_description) {
      ...
      null !== v.textpanel_desc_color && (i.color = v.textpanel_desc_color),
        null !== v.textpanel_desc_font_family &&
          (i["font-family"] = v.textpanel_desc_font_family),
        null !== v.textpanel_desc_text_align &&
          (i["text-align"] = v.textpanel_desc_text_align),
        null !== v.textpanel_desc_font_size &&
          (i["font-size"] = v.textpanel_desc_font_size + "px"),
        null !== v.textpanel_desc_bold &&
          (v.textpanel_desc_bold === !0
            ? (i["font-weight"] = "bold")
            : (i["font-weight"] = "normal")),
        v.textpanel_css_title &&
          (i = jQuery.extend(i, v.textpanel_css_description)),
        c.css(i);
    }
  }
  function s() {
  ...
  (this.positionElements = function (t) {
    ...
    (this.init = function (e, t, i) {
      if (
        ((h = e),
        i && ((_ = i), (t = f.convertCustomPrefixOptions(t, _, "textpanel"))),
        t && (v = jQuery.extend(v, t)),
        0 == v.textpanel_enable_title && 0 == v.textpanel_enable_description)
      )
        throw new Error(
          "Textpanel Error: The title or description must be enabled"
        );
      v.textpanel_height &&
        v.textpanel_height < 0 &&
        (v.textpanel_height = null),
        1 == v.textpanel_desc_style_as_title &&
          (v.textpanel_desc_color ||
            (v.textpanel_desc_color = v.textpanel_title_color),
          v.textpanel_desc_bold ||
            (v.textpanel_desc_bold = v.textpanel_title_bold),
          v.textpanel_desc_font_family ||
            (v.textpanel_desc_font_family = v.textpanel_title_font_family),
          v.textpanel_desc_font_size ||
            (v.textpanel_desc_font_size = v.textpanel_title_font_size),
          v.textpanel_desc_text_align ||
            (v.textpanel_desc_text_align = v.textpanel_title_text_align));
    }),
    (this.appendHTML = function (e, t) {
      (u = e), (t = t ? " " + t : "");
      var i = "<div class='ug-textpanel" + t + "'>";
      1 == v.textpanel_enable_bg &&
        (i += "<div class='ug-textpanel-bg" + t + "'></div>"),
        (i += "<div class='ug-textpanel-textwrapper" + t + "'>"),
        1 == v.textpanel_enable_title &&
          (i += "<div class='ug-textpanel-title" + t + "'></div>"),
        1 == v.textpanel_enable_description &&
    ...
    (this.setPanelSize = function (e, t) {
      ...
      v.textpanel_height && (t = v.textpanel_height),
        l.width(e),
        l.height(t),
        g && (g.width(e), g.height(t));
      var i = e - v.textpanel_padding_left - v.textpanel_padding_right,
        n = v.textpanel_padding_left;
      f.setElementSizeAndPosition(p, n, 0, i, t),
        d && d.width(i),
        c && c.width(i),
        0 == b.isFirstTime && m.positionElements(!1);
    }),
    ...
    (this.setText = function (e, t) {
      1 == b.isFirstTime
        ...
        : p.stop().fadeTo(v.textpanel_fade_duration, 0, function () {
            m.setTextPlain(e, t),
              m.positionElements(!0),
              jQuery(this).fadeTo(v.textpanel_fade_duration, 1);
          });
    }),
    ...
    (this.setOptions = function (e) {
      _ && (e = f.convertCustomPrefixOptions(e, _, "textpanel")),
        (v = jQuery.extend(v, e));
    }),
    (this.getElement = function () {
      return l;
    ...
    (this.refresh = function (e, t, i, n) {
      a(),
        i ? m.setPanelSize(i, n) : m.setSizeByParent(),
        m.positionElements(!1),
        t !== !0 && m.positionPanel(),
        e === !0 && m.show();
    }),
    (this.hide = function () {
  ...
  (this.init = function (e, t) {
    ...
    (this.setObjects = function (e, t, i) {
      (s = e),
        ...
        l && l.addClass("ug-zoompanel-button-disabled");
    }),
    (this.getElement = function () {
      return r;
    }),
...
function UGBullets() {
  function e() {
    var e = "",
      t = "";
    -1 != h.bullets_space_between &&
      (t = " style='margin-left:" + h.bullets_space_between + "px'");
    for (var i = 0; u > i; i++)
      e +=
        0 == i
  ...
  (this.events = { BULLET_CLICK: "bullet_click" }),
    (this.init = function (e, t, i) {
      (d = e),
        ...
        (p.isInited = !0),
        (h = jQuery.extend(h, t)),
        "" == h.bullets_skin && (h.bullets_skin = h.gallery_skin);
    }),
    ...
    (this.appendHTML = function (t) {
      ...
      var o =
        "<div class='ug-slider-control ug-bullets ug-skin-" +
        h.bullets_skin +
        n +
        "'>";
...
function UGProgressPie() {
  function e(e) {
    if (!e) var e = 0;
    var t =
        Math.min(s.slider_progresspie_width, s.slider_progresspie_height) / 2,
      n = i[0].getContext("2d");
    0 == r && ((r = !0), n.rotate(1.5 * Math.PI), n.translate(-2 * t, 0)),
      n.clearRect(
        0,
        0,
        s.slider_progresspie_width,
        s.slider_progresspie_height
      );
    var a = s.slider_progresspie_width / 2,
      o = s.slider_progresspie_height / 2,
      l = 0,
      u = e * Math.PI * 2;
    if (1 == s.slider_progresspie_type_fill)
      n.beginPath(),
        n.moveTo(a, o),
        n.arc(a, o, t, l, u),
        n.lineTo(a, o),
    ...
    1 == s.slider_progresspie_type_fill &&
      ((l = u),
      (u = 2 * Math.PI),
      n.beginPath(),
      n.arc(a, o, t, l, u),
      n.lineTo(a, o),
      (n.fillStyle = s.slider_progresspie_color2),
      n.fill(),
      n.closePath());
  }
  var t,
...
function UGTouchSliderControl() {
  ...
  function a(e) {
    ...
    if (
      (0 == b.isDragging &&
        ((b.isDragging = !0), m.trigger(_.events.START_DRAG)),
      h.css("left", a + "px"),
      1 == b.isDragVideo)
    ) {
      var u = a - b.startPosx,
  ...
  function s(e) {
    ...
    (b.startMouseX = t.pageX),
      (b.startMouseY = t.pageY),
      (b.lastMouseX = b.startMouseX),
      (b.lastMouseY = b.startMouseY),
      (b.startTime = jQuery.now());
    ...
    (b.startPosx = n.left),
      (b.isInitDataValid = !0),
      (b.isDragVideo = !1),
      v.storeEventData(e, b.storedEventID);
  }
  function o(e) {
    b.touch_active = !1;
  }
  ...
  function u(e) {
    e.preventDefault(),
      (b.isDragging = !1),
      1 == _.isAnimating() && h.stop(!0, !0);
    var t = v.getArrTouches(e);
    return t.length > 1
      ? (1 == b.touch_active && o("1"), !0)
      : 1 == b.touch_active || void l("1", e);
  }
  function d(e) {
    ...
    var i = null;
    1 == f.slider_vertical_scroll_ondrag &&
      (i = v.handleScrollTop(b.storedEventID)),
      "vert" !== i && a(e);
  }
  function c(e) {
  ...
  function g() {
    p.bind("mousedown touchstart", u),
      jQuery("body").bind("mousemove touchmove", d),
      jQuery(window).add("body").bind("mouseup touchend", c);
  }
  var p,
    h,
    m,
  ...
  (this.isTapEventOccured = function (t) {
    ...
    (this.init = function (e, t) {
      (_ = e),
        (m = jQuery(_)),
        (g_objects = e.getObjects()),
        (p = g_objects.g_objSlider),
        (h = g_objects.g_objInner),
        (f = jQuery.extend(f, t)),
        g();
    }),
...
function UGZoomSliderControl() {
  function e(e, t) {
    (x = e),
      (T = jQuery(x)),
      (g_objects = e.getObjects()),
      (y = g_objects.g_objSlider),
      (w = g_objects.g_objInner),
      (I = jQuery.extend(I, t)),
      b();
  }
  function t() {
  ...
  function i() {
    ...
    if (
      ((E.objSlide = n.objCurrentSlide),
      (E.objImage = n.objCurrentSlide.find("img")),
      0 == E.objImage.length)
    )
      return !1;
    (E.objImageSize = S.getElementSize(E.objImage)),
      (E.objParent = E.objImage.parent()),
      (E.objParentSize = S.getElementSize(E.objParent));
    var r = t();
    (objPadding = x.getObjImagePadding()),
      (E.objFitImageSize = S.getImageInsideParentDataByImage(
        E.objImage,
        r,
        objPadding
      ));
  ...
  function n(e, i) {
    ...
    if ("back" == e) {
      ...
      var u = "in" == e;
      s = S.zoomImageInsideParent(
        r,
        u,
        I.slider_zoom_step,
        i,
        a,
        I.slider_zoom_max_ratio,
        o
      );
    }
    1 == s &&
      (T.trigger(x.events.ZOOMING),
      T.trigger(x.events.ZOOM_CHANGE),
      T.trigger(x.events.ZOOM_END));
  }
  function r(e, t, i) {
  ...
  function o(e) {
    ...
    var t = S.getMousePosition(e),
      i =
        (t.pageX - E.startMouseX,
        t.pageY - E.startMouseY,
        t.pageX - E.lastMouseX),
    ...
    0 == E.panYActive
      ...
      : "down" == a && s.top > 0
      ? (n /= 3)
      : "up" == a && s.bottom < E.objParentSize.height && (n /= 3),
      0 == E.panXActive || 0 == x.isInnerInPlace()
        ? (i = 0)
        : "right" == r && s.left > 0
        ? (i /= 3)
        : "left" == r && s.right < E.objParentSize.width && (i /= 3);
    var o = s.left + i,
      l = s.top + n;
  ...
  function l() {
    ...
    (E.panXActive = E.objImageSize.width > E.objParentSize.width),
      ...
      1 == E.panYActive
        ? r.top > 0
          ? ((n = 0), (t = !0))
          : r.bottom < E.objParentSize.height &&
            ((n = E.objParentSize.height - r.height), (t = !0))
        : r.top != s.top && ((t = !0), (n = s.top)),
      1 == E.panXActive
        ? r.left > 0
          ? ((i = 0), (e = !0))
          : r.right < E.objParentSize.width &&
            ((i = E.objParentSize.width - r.width), (e = !0))
        : r.left != s.left && ((e = !0), (i = s.left));
    var o = {};
    1 == t && (o.top = n + "px"),
      1 == e && (o.left = i + "px"),
      (1 == t || 1 == e) &&
        E.objImage.animate(o, {
  ...
  function d(e) {
    (E.isZoomActive = !0),
      ...
      (E.startMiddlePoint = S.getMiddlePoint(
        e[0].pageX,
        e[0].pageY,
        e[1].pageX,
        e[1].pageY
      ...
      (E.startImageX = E.objImageSize.left),
      (E.startImageY = E.objImageSize.top),
      (E.imageOrientPoint = S.getElementLocalPoint(
        E.startMiddlePoint,
        E.objImage
      ));
    var t = S.isPointInsideElement(E.imageOrientPoint, E.objImageSize);
    0 == t && (E.imageOrientPoint = S.getElementCenterPoint(E.objImage)),
      T.trigger(x.events.ZOOM_START);
  }
  function c(e) {
  ...
  function p(e) {
    var t = S.getArrTouches(e),
      ...
      l = 1;
    if ((o.width > 0 && (l = a / o.width), l > I.slider_zoom_max_ratio))
      return !0;
    (panX = -(E.imageOrientPoint.x * n - E.imageOrientPoint.x)),
      (panY = -(E.imageOrientPoint.y * n - E.imageOrientPoint.y));
    var u = r.x - E.startMiddlePoint.x,
      d = r.y - E.startMiddlePoint.y,
      c = E.startImageX + panX + u,
      g = E.startImageY + panY + d;
    S.setElementSizeAndPosition(E.objImage, c, g, a, s),
      T.trigger(x.events.ZOOMING),
      T.trigger(x.events.ZOOM_CHANGE);
  }
  function h() {
  ...
  function m(e) {
    return (
      ...
      void 0 == E.objImage ||
        0 == E.objImage.length ||
        (e.preventDefault(),
        1 == u() && E.objImage.stop(!0),
        1 == E.isZoomActive ? c(e) : g(e),
        void (1 == E.isZoomActive
          ? (E.isPanActive = !1)
          : 1 == r(E.objImage, e) && 1 == E.isZoomedOnce && s(e))))
    );
  }
  function f(e) {
    ...
    var n = E.isPanActive,
      a = E.isZoomActive;
    if (0 == x.isInnerInPlace())
      return (E.isZoomActive = !1), (E.isPanActive = !1), !0;
    if ((1 == E.isZoomActive ? c(e) : g(e), 1 == E.isZoomActive))
      E.isPanActive = !1;
    else {
  ...
  function _(e) {
    return (
      0 == x.isCurrentSlideType("image") ||
      void (1 == E.isZoomActive ? p(e) : 1 == E.isPanActive && o(e))
    );
  }
  function v(e, t, i, r) {
  ...
  (this.events = {
    ...
    (this.loadAPI = function () {
      return (
        ...
        (e()
          ? ((g_ugSoundCloudAPI.isAPILoaded = !0), !0)
...
function UGHtml5MediaAPI() {
  ...
  function t(e, t, n, a, s) {
    ...
    "" != t.mp4 && (g += "<source type='video/mp4' src='" + t.mp4 + "' />"),
      "" != t.webm &&
        (g += "<source type='video/webm' src='" + t.webm + "' />"),
      ...
      (g +=
        "<param name='flashvars' value='controls=true&file=" + t.mp4 + "' />"),
      (g += "</object>"),
      (g += "</video>"),
      jQuery("#" + e).html(g),
      new MediaElement(u, {
...
function UGVimeoAPI() {
  ...
  function t(e, t, n, a, s) {
    ...
    s === !0 &&
      (u += "&amp;byline=0&amp;autoplay=1&amp;title=0&amp;portrait=0");
    var d =
      "<iframe src=" +
      u +
      " width='" +
  ...
  (this.events = {
    ...
    (this.loadAPI = function () {
      return (
        ...
        (e()
          ? ((g_ugVimeoAPI.isAPILoaded = !0), !0)
          : (g_ugFunctions.loadJs("f.vimeocdn.com/js/froogaloop2.min.js", !0),
    ...
    (this.getVideoImages = function (e, t, i) {
      ...
      jQuery.get(n, {}, function (e) {
        var n = {};
        (n.preview = e[0].thumbnail_large),
          (n.thumb = e[0].thumbnail_medium),
          i(t, n);
      });
    });
}
function UGYoutubeAPI() {
  ...
  function n() {
    if ("function" != typeof o.getPlayerState)
  ...
  (this.events = {
    ...
    (this.loadAPI = function () {
      return (
        ...
        ("undefined" != typeof YT
          ? ((g_ugYoutubeAPI.isAPILoaded = !0), !0)
    ...
    (this.changeVideo = function (e, t) {
      return (
        0 != s.isPlayerReady() &&
        void (t && 1 == t
          ? o.loadVideoById(e, 0, "large")
          : o.cueVideoById(e, 0, "large"))
      );
    }),
    (this.isPlayerReady = function () {
      return !(!l || !o);
  ...
  (this.init = function (e, t, i) {
    ...
    (this.setHtml = function (e) {
      ...
      (t +=
        ...
        0 == S.standAloneMode &&
          1 == x.video_enable_closebutton &&
          (c = o.children(".ug-videoplayer-button-close"));
    }),
    (this.destroy = function () {
    ...
    (this.show = function () {
      return (
        1 == h.isVisible() ||
        (o.show(), o.fadeTo(0, 1), c && c.show(), void m.trigger(h.events.SHOW))
      );
    }),
    (this.hide = function () {
      return (
        0 == h.isVisible() ||
        (a(), (T = null), o.hide(), void m.trigger(h.events.HIDE))
      );
    }),
    ...
    (this.playYoutube = function (e, t) {
      ...
      0 == i.length && l.append("<div id='" + S.youtubeInnerID + "'></div>"),
        1 == _.isPlayerReady() && 1 == S.standAloneMode
          ? _.changeVideo(e, t)
          : _.putVideo(S.youtubeInnerID, e, "100%", "100%", t),
        (T = "youtube");
    }),
    (this.playVimeo = function (e, t) {
      ...
      a("vimeo"),
        u.show(),
        v.putVideo(S.vimeoPlayerID, e, "100%", "100%", t),
        (T = "vimeo");
    }),
    ...
    (this.playSoundCloud = function (e, t) {
      ...
      a("soundcloud"),
        g.show(),
        y.putSound(S.soundCloudPlayerID, e, "100%", "100%", t),
        (T = "soundcloud");
    }),
    (this.playWistia = function (e, t) {
      ...
      a("wistia"),
        p.show(),
        w.putVideo(S.wistiaPlayerID, e, "100%", "100%", t),
        (T = "wistia");
    });
}
...
function ugCheckForErrors(e, t) {
  ...
  try {
    "jquery" == t
      ? (i(), ugCheckForMinJQueryVersion())
      : (ugCheckForMinJQueryVersion(), n());
  } catch (i) {
    var r = i.message;
    if (
...
function UniteGalleryMain() {
  ...
  function runGallery(e, i, n, r) {
    ...
    1 == g_temp.isRunFirstTime &&
      ...
      ((g_objTabs = new UGTabs()), g_objTabs.init(t, g_options)),
      1 == g_temp.isRunFirstTime &&
        1 == g_options.gallery_enable_loadmore &&
        ((g_objLoadMore = new UGLoadMore()), g_objLoadMore.init(t, g_options)),
  ...
  function modifyInitParams() {
    g_options.gallery_images_preload_type ||
      ...
      (void 0 == g_options.gallery_min_height ||
        g_options.gallery_height < g_options.gallery_min_height) &&
        (g_options.gallery_min_height = 0),
      (void 0 == g_options.gallery_min_width ||
  ...
  function setHeightByOriginalRatio() {
    ...
    if (i != e.orig_ratio) {
      ...
      (n = Math.round(n)),
        n < g_options.gallery_min_height && (n = g_options.gallery_min_height),
        g_objWrapper.height(n);
    }
  }
  function setHtmlObjectsProperties() {
    ...
    g_options.gallery_background_color &&
      (t["background-color"] = g_options.gallery_background_color),
      g_objWrapper.css(t);
  }
  function fillItemByChild(e) {
    ...
    if (((s.type = a), "img" == n)) {
      ...
      l || (l = d),
        ...
        (s.title = e.attr("alt")),
        (s.objThumbImage = e),
        s.objThumbImage.attr("src", s.urlThumb);
    } else {
      if ("image" == a)
        throw (
      ...
      (s.urlThumb = e.data("thumb")),
        (s.title = e.data("title")),
        (s.objThumbImage = null),
        (s.urlImage = e.data("image"));
    }
    if (1 == i) {
      var c = e.data("thumb-mobile");
      "undefined" != typeof c &&
        "" != c &&
        ((s.urlThumb = c), "img" == n && e.attr("src", s.urlThumb));
    ...
    p &&
      ...
      ((s.thumbWidth = p),
      (s.thumbHeight = h),
      (s.thumbRatioByWidth = p / h),
      (s.thumbRatioByHeight = h / p)),
      (s.addHtml = null);
    ...
    switch (s.type) {
      case "youtube":
        if (((s.videoid = e.data("videoid")), m || f)) {
          ...
          m && (s.urlImage = _.preview),
            f &&
              ((s.urlThumb = _.thumb), "img" == n && e.attr("src", s.urlThumb));
        }
      ...
      case "vimeo":
        ...
        break;
      case "html5video":
        (s.videoogv = e.data("videoogv")),
          (s.videowebm = e.data("videowebm")),
          (s.videomp4 = e.data("videomp4")),
    ...
    return (
      s.objThumbImage &&
        (s.objThumbImage.removeAttr("data-description", ""),
        s.objThumbImage.removeAttr("data-image", ""),
        s.objThumbImage.removeAttr("data-thumb", ""),
        s.objThumbImage.removeAttr("title", "")),
      s
    );
  }
    ...
    return "" == i || void 0 == i
      ...
      : ((e.isBigImageLoadStarted = !0),
        ...
        e.objPreloadImage.on("error", function () {
          ...
          console.log("Can't load image: " + r),
            g_objGallery.trigger(t.events.ITEM_IMAGE_UPDATED, [i, n.urlImage]),
            n.objThumbImage.attr("src", n.urlThumb);
        }),
  ...
  function preloadNearBigImages(e) {
    ...
    var t = e.index,
      i = t - 1,
      n = t + 1;
    i > 0 && preloadItemImage(g_arrItems[i]),
      g_numItems > n && preloadItemImage(g_arrItems[n]);
  }
  ...
  function onKeyPress(e) {
    ...
    1 == r &&
      ...
      g_objGallery.trigger(t.events.GALLERY_KEYPRESS, [n, e]);
  }
  function onGalleryResized() {
    ...
    var e = t.getSize();
    if (
      e.width != g_temp.lastWidth ||
      (0 == g_temp.isFreestyleMode && e.height != g_temp.lastHeight)
    ) {
      var i = !1;
  ...
  (this.onItemBigImageLoaded = function (e, t) {
    ...
    (this.resetPlaying = function () {
      return (
        0 == g_temp.isPlayMode ||
        ((g_temp.playTimePassed = 0),
        void (g_temp.playTimeLastStep = jQuery.now()))
      );
    }),
    (this.pausePlaying = function () {
      return (
        1 == g_temp.isPlayModePaused ||
        ((g_temp.isPlayModePaused = !0),
        clearInterval(g_temp.playHandle),
        void g_objGallery.trigger(t.events.PAUSE_PLAYING))
      );
    }),
    (this.continuePlaying = function () {
      return (
        0 == g_temp.isPlayModePaused ||
        ((g_temp.isPlayModePaused = !1),
        (g_temp.playTimeLastStep = jQuery.now()),
        void (g_temp.playHandle = setInterval(
          advanceNextStep,
          g_temp.playStepInterval
        )))
      );
    ...
    (this.nextItem = function () {
      ...
      return (
        0 == g_numItems ||
        (0 == g_options.gallery_carousel && e >= g_numItems) ||
        (e >= g_numItems && (e = 0), void t.selectItem(e, "next"))
      );
    }),
    (this.prevItem = function () {
      var e = g_selectedItemIndex - 1;
      return (
        -1 == g_selectedItemIndex && (e = 0),
        0 == g_numItems ||
          (0 == g_options.gallery_carousel && 0 > e) ||
          (0 > e && (e = g_numItems - 1), void t.selectItem(e, "prev"))
      );
    }),
    (this.isFullScreen = function () {
    ...
    (this.setSizeClass = function (e, i) {
      ...
      return (
        480 >= i
          ...
          : 780 >= i
          ? (r = "ug-under-780")
          : 960 > i && (r = "ug-under-960"),
        1 == e.hasClass(r) ||
          (removeAllSizeClasses(e), void ("" != r && e.addClass(r)))
      );
    }),
    ...
    (this.addItems = function (e) {
      ...
      0 == t.length &&
        ...
        (t = g_objWrapper.children(".ug-newitems-wrapper")),
        t.append(e);
    ...
    (this.ajaxRequest = function (e, t, i, n) {
      ...
      jQuery.ajax({
        ...
        success: function (e) {
          ...
          return 0 == e.success
            ? (showErrorMessage(e.message, "ajax error"), !1)
            : void i(e);
        },
        error: function (e, t, i) {
          console.log("Ajax Error!!! " + t),
            (responseText = e.responseText),
            n && "function" == typeof n ? n(responseText) : trace(responseText);
        },
      });
    }),
...
function UGLightbox() {
  function e(e, i) {
    (ie = e),
      ...
      "compact" == se.lightbox_type &&
        ((oe.isCompact = !0),
        (se = jQuery.extend(se, ue)),
        (se = jQuery.extend(se, i))),
      t(),
      1 == oe.putSlider
        ? (ie.initSlider(se, "lightbox"),
          (g_objects = e.getObjects()),
          (ne = g_objects.g_objSlider))
        : (ne = null),
      1 == se.lightbox_show_textpanel
        ? ae.init(ie, se, "lightbox")
        : (ae = null);
  }
  function t() {
    1 == oe.isCompact &&
      1 == se.lightbox_show_textpanel &&
      (se.lightbox_slider_image_padding_bottom = oe.initTextPanelHeight),
      1 == oe.isCompact &&
        "inside" == se.lightbox_arrows_position &&
        (oe.isArrowsInside = !0),
      1 == oe.isArrowsInside &&
        0 == se.lightbox_arrows_inside_alwayson &&
        (oe.isArrowsOnHoverMode = !0),
      0 == se.lightbox_show_textpanel &&
        ((oe.isTopPanelEnabled = !1),
        (oe.topPanelHeight = 0),
        (se.lightbox_slider_image_padding_top = 0));
  }
  function i() {
    var e = "",
      t = "";
    1 == oe.isCompact && (t = " ug-lightbox-compact"),
      ...
      0 == oe.isCompact &&
        1 == oe.isTopPanelEnabled &&
        ((J = U.children(".ug-lightbox-top-panel")),
        0 == J.length && (J = null)),
  ...
  function n() {
    if (
      (null !== se.lightbox_overlay_color &&
        V.css("background-color", se.lightbox_overlay_color),
      null !== se.lightbox_overlay_opacity &&
        V.fadeTo(0, se.lightbox_overlay_opacity),
      J &&
        null !== se.lightbox_top_panel_opacity &&
        J.children(".ug-lightbox-top-panel-overlay").fadeTo(
          0,
          se.lightbox_top_panel_opacity
        ),
      $)
    ) {
      var e = {};
      null !== se.lightbox_numbers_size &&
        (e["font-size"] = se.lightbox_numbers_size + "px"),
        se.lightbox_numbers_color && (e.color = se.lightbox_numbers_color),
        null !== se.lightbox_numbers_padding_right &&
          (e["padding-right"] = se.lightbox_numbers_padding_right + "px"),
        null !== se.lightbox_numbers_padding_top &&
          (e["padding-top"] = se.lightbox_numbers_padding_top + "px"),
        $.css(e);
    }
  }
  function r(e) {
  ...
  function a(e) {
    ...
    var i = t,
      n = ae.getSize(),
      a = n.height;
    t != oe.topPanelHeight && (i = oe.topPanelHeight),
      a > i && (i = a),
      t != i && (J.height(i), ne && 0 == ne.isAnimating() && r(i));
  }
  function s(e) {
    var t = {},
      ...
      s = e.width - n - r;
    i > s
      ? ((t.textpanel_padding_left = n),
        (t.textpanel_padding_right = r),
        (t.textpanel_title_text_align = "center"),
        (t.textpanel_desc_text_align = "center"))
      : ((t.textpanel_padding_left = Math.floor((e.width - i) / 2)),
        ...
        se.lightbox_textpanel_title_text_align &&
          (t.textpanel_title_text_align =
            se.lightbox_textpanel_desc_text_align),
        se.lightbox_textpanel_desc_text_align &&
          (t.textpanel_desc_text_align =
            se.lightbox_textpanel_desc_text_align)),
      ae.setOptions(t),
      ae.refresh(!0, !0),
  ...
  function u(e) {
    ...
    if (s != a.slider_image_padding_bottom) {
      ...
      if (0 == ne.isAnimating())
        return ne.setOptions(o), ne.refreshSlideItems(), !0;
    }
    return !1;
  }
  function d(e, t) {
    ...
    (oe.textPanelTop = e.bottom),
      t === !0 && ae.positionPanel(oe.textPanelTop, oe.textPanelLeft);
  }
  function c(e) {
    ...
    var s = u(i);
    0 == s &&
      ((oe.positionFrom = "handleCompactTextpanelSizes"),
      ae &&
        (ae.positionPanel(oe.textPanelTop, oe.textPanelLeft),
        e === !0 && (e(), C())));
  }
  function g() {
  ...
  function p(e, t) {
    ...
    if (
      (q.show(),
      Z.show(),
      (oe.positionFrom = "positionArrowsInside"),
      1 == oe.isArrowsOnHoverMode && 1 == i && 0 == y() && w(!0),
      0 == i)
    )
      ...
      var o = ne.getSlideImage(),
        ...
        n =
          (re.getElementSize(ne.getElement()),
          re.getElementRelativePos(q, "left", 0, o) +
            l.left +
            se.lightbox_arrows_inside_offset),
        r = re.getElementRelativePos(q, "middle", 0, o) + l.top,
        a =
          re.getElementRelativePos(q, "right", 0, o) +
          l.left -
          se.lightbox_arrows_inside_offset,
        s = r;
    if (t === !0) {
      var u = { left: n, top: r },
        d = { left: a, top: s };
      q.stop().animate(u, { duration: oe.fadeDuration }),
        Z.stop().animate(d, { duration: oe.fadeDuration });
    } else
      q.stop(), Z.stop(), re.placeElement(q, n, r), re.placeElement(Z, a, s);
    1 == e && x(t);
  }
  function h(e, t) {
    ...
    if (0 == i)
      ...
      var s =
          ...
          l.right -
          d.width / 2 +
          se.lightbox_compact_closebutton_offsetx,
        a =
          u.top +
          l.top -
          d.height / 2 -
          se.lightbox_compact_closebutton_offsety;
      n > a && (a = n), s > r && (s = r);
    }
    if (t === !0) {
      var c = { left: s, top: a };
  ...
  function m() {
    K && K.stop().fadeTo(oe.fadeDuration, 0),
      v(),
      b(),
      (oe.positionFrom = "hideCompactElements"),
      1 == oe.isArrowsInside && w();
  }
  function f() {
    K && K.hide(),
      q && 1 == oe.isArrowsInside && (q.hide(), Z.hide()),
      $ && $.hide(),
      ae && ae.hide();
  }
  function _() {
    ...
    J && re.setElementSizeAndPosition(J, 0, 0, e.width, oe.topPanelHeight),
      q &&
        0 == oe.isArrowsInside &&
        (1 == se.lightbox_hide_arrows_onvideoplay && (q.show(), Z.show()),
        re.placeElement(q, "left", "middle", se.lightbox_arrows_offset),
        re.placeElement(Z, "right", "middle", se.lightbox_arrows_offset)),
      0 == oe.isCompact && re.placeElement(K, "right", "top", 2, 2),
      ae &&
        ((oe.positionFrom = "positionElements"),
        0 == oe.isCompact ? s(e) : (P(), C()));
    var t = e.width,
      i = e.height,
      n = 0,
      r = 0;
  ...
  function w(e, t) {
    return (
      !!q &&
      (1 == oe.isArrowsOnHoverMode && t === !1
        ? (1 == y(), !0)
        : void (e === !0
            ? (q.stop().fadeTo(0, 0), Z.stop().fadeTo(0, 0))
            : (q.stop().fadeTo(oe.fadeDuration, 0),
              Z.stop().fadeTo(oe.fadeDuration, 0))))
    );
  }
  function T() {
    if (!q) return !0;
  ...
  function x(e, t) {
    return (
      !!q &&
      ((1 == oe.isArrowsOnHoverMode && t !== !0 && 1 == g()) ||
        1 == ne.isSwiping() ||
        (e !== !0 && (q.stop(), Z.stop()),
        q.fadeTo(oe.fadeDuration, 1),
        void Z.fadeTo(oe.fadeDuration, 1)))
    );
  }
  function S(e) {
  ...
  function P() {
    return (
      !!ae && void ae.getElement().show().stop().fadeTo(oe.fadeDuration, 1)
    );
  }
  function C() {
  ...
  function z(e, t) {
    return (
      (t = jQuery(t)),
      0 == oe.isCompact ||
        0 == ne.isSlideCurrent(t) ||
        ((oe.positionFrom = "onSliderAfterPutImage"), h(!0), p(!0), void c())
    );
  }
  function O() {
    var e = ne.getOptions(),
    ...
    if (1 == oe.isCompact) {
      if (
        (I(),
        E(),
        (oe.positionFrom = "onSliderTransitionEnd"),
        h(!0),
        p(!0),
        0 == ne.isSlideActionActive())
      ) {
        var n = u();
        0 == n && c();
      }
  ...
  function k(e, t) {
    0 == oe.isCompact
      ? ($ && E(t),
        ae &&
          (I(t),
          0 == oe.isRightNowOpened &&
            (ae.positionElements(!1), a("onchange"), ae.positionPanel())))
      : 0 == ne.isAnimating() && (ae && I(t), $ && E(t)),
      0 == oe.isSliderChangedOnce &&
        ((oe.isSliderChangedOnce = !0), te.trigger(ee.events.LIGHTBOX_INIT));
  }
  function L(e, t) {
    var i = ne.getSlideType();
    if ("image" != i && 0 == oe.isCompact && ne.isSlideActionActive())
      return !0;
  ...
  function N() {
    J ? o() : $ && $.hide(),
      q && 1 == se.lightbox_hide_arrows_onvideoplay && (q.hide(), Z.hide());
  }
  function D() {
    J ? (l(), a("onStopVideo")) : $ && $.show(),
      q && 1 == se.lightbox_hide_arrows_onvideoplay && (q.show(), Z.show());
  }
  function R(e, t, i) {
    var n = !1;
    switch (t) {
  ...
  function B(e) {
    (oe.positionFrom = "hideCompactElements"),
      1 == oe.isArrowsOnHoverMode && 1 == g() && w(!1, !0);
  }
  function W(e) {
    ...
    1 == t &&
      y() &&
      0 == ne.isAnimating() &&
      ((oe.positionFrom = "onMouseMove"),
      q && 0 == q.is(":animated") && x(!1, !0));
  }
  function F(e, t, i, n) {
  ...
  function Q() {
    if (
      ...
      jQuery(ne).on(ne.events.TRANSITION_END, O),
        jQuery(ne).on(ne.events.CLICK, L);
    ...
    jQuery(window).resize(function () {
      return (
        0 == oe.isOpened ||
        void re.whenContiniousEventOver("lightbox_resize", H, 100)
      );
    }),
  ...
  function Y() {
    (oe.isCompact = !1),
      t(),
      (oe.isArrowsInside = !1),
      (oe.isArrowsOnHoverMode = !1),
      (se = jQuery.extend({}, oe.originalOptions)),
      (se.lightbox_arrows_position = "sides"),
      ne.setOptions(se);
  }
  var X,
    U,
  ...
  (this.destroy = function () {
    ...
    jQuery(window).unbind("resize"),
      X.off(ie.events.GALLERY_KEYPRESS, R),
      U.off("mousewheel"),
      U.remove();
  }),
...
function UGCarousel() {
  ...
  function t(e) {
    ...
    H.append(t),
      (D = H.children(".ug-carousel-wrapper")),
      (R = D.children(".ug-carousel-inner")),
      Q.setHtml(R),
      Y.getThumbs().fadeTo(0, 1);
  }
  function i(e, t) {
  ...
  function n() {
    ...
    if (U.tileWidth < U.initTileWidth) {
      ...
      var t = F.getNumItemsInSpace(
        U.carouselMaxWidth,
        e,
        X.carousel_space_between_tiles
      );
    } else {
      var t = F.getNumItemsInSpace(
        U.carouselMaxWidth,
        ...
        ? (O(),
          ...
          jQuery.each(N, function (e, t) {
            t.objThumbWrapper.data("index", e),
              H.trigger(U.eventSizeChange, [t.objThumbWrapper, !0]),
              (t.objTileOriginal = t.objThumbWrapper.clone(!0, !0));
          }),
          _(!0),
          1 == X.carousel_autoplay && G.startAutoplay())
        : (1 == X.carousel_autoplay && G.pauseAutoplay(),
          T(0, !1),
          1 == X.carousel_autoplay && G.startAutoplay()),
      E(),
      (U.isFirstTimeRun = !1);
  ...
  function _(e) {
    ...
    return (
      jQuery.each(i, function (e, a) {
        ...
        (n += s.width + X.carousel_space_between_tiles),
          (r = Math.max(r, s.height)),
          e == i.length - 1 && (t = s.right);
      }),
      R.width(t),
  ...
  function b(e, t) {
    ...
    jQuery.each(r, function (e, i) {
      "left" == t ? R.prepend(i) : R.append(i),
        H.trigger(U.eventSizeChange, i),
        Q.loadTileImage(i);
    });
  }
  function y(e, t) {
    v(n);
    for (var i = s(), n = i.length, r = 0; e > r; r++)
  ...
  function I() {
    ...
    if (
      (t > U.spaceActionSize
        ? ((n = o(t)), b(n, "right"))
        : t < -U.spaceActionSize && ((a = o(Math.abs(t))), y(a, "right")),
      a > s)
    )
  ...
  function P() {
    "left" == X.carousel_autoplay_direction
      ? G.scrollRight(1)
      : G.scrollLeft(1);
  }
  function C(e) {
  ...
  function j(e) {
    ...
    var t = null;
    if (
      (1 == X.carousel_vertical_scroll_ondrag &&
        (t = F.handleScrollTop(U.storedEventID)),
      "vert" === t)
    )
      return !0;
    U.lastMousePos = a(e);
    ...
    n > 0 && "prev" == r && (n /= 3),
      -s > n && "next" == r && (n = U.startInnerPos + i / 3),
      w(n);
  }
  function A(e) {
    return (
      0 == U.touchActive ||
      ((U.touchActive = !1), S(), void G.unpauseAutoplay())
    );
  }
  function M(e) {
    return (
      0 == X.carousel_autoplay_pause_onhover ||
      void (1 == U.isPlayMode && 0 == U.isPaused && G.pauseAutoplay())
    );
  }
  function z(e) {
  ...
  function O() {
    Q.initEvents(),
      ...
      jQuery("body").bind("mousemove touchmove", j),
  ...
  (this.startAutoplay = function () {
    (U.isPlayMode = !0),
      (U.isPaused = !1),
      B.trigger(G.events.START_PLAY),
      U.handle && clearInterval(U.handle),
      (U.handle = setInterval(P, X.carousel_autoplay_timeout));
  }),
    ...
    (this.pauseAutoplay = function () {
      return (
        ...
        ((U.isPaused = !0),
        U.handle && clearInterval(U.handle),
        void B.trigger(G.events.PAUSE_PLAY))
      );
    }),
    (this.stopAutoplay = function () {
      return (
        ...
        (U.isPlayMode = !1),
        U.handle && clearInterval(U.handle),
        void B.trigger(G.events.STOP_PLAY))
      );
    }),
    (this.destroy = function () {
      U.handle && clearInterval(U.handle),
...
function UGTabs() {
  function e(e, t) {
    (u = e),
      ...
      (d = jQuery.extend(d, t)),
      "select" == d.tabs_type
        ? (l = jQuery(d.tabs_container))
        : (o = jQuery(d.tabs_container + " .ug-tab"));
  }
  function t() {
    a();
  }
...
function UGLoadMore() {
  function e() {
    return (
      ...
      0 != a.length &&
        ((s = a.find(".ug-loadmore-button")),
        0 != s.length &&
          ((o = a.find(".ug-loadmore-loader")),
          0 != o.length &&
            ((l = a.find(".ug-loadmore-error")),
            0 != l.length && void (d.isInited = !0))))
    );
  }
  function t() {
    a.show();
...
function UGTheme_tiles() {
  function e(e, i) {
    (h = e),
      ...
      m.init(e, b),
      f.init(e, b),
      (v = m.getObjTileDesign());
  }
  function t() {
    switch (
      (1 == b.theme_enable_preloader && (w.showPreloader = !0),
      b.theme_appearance_order)
    ) {
      default:
      case "normal":
        break;
  ...
  function i() {
    c.addClass("ug-theme-tiles"),
      c.append(
        "<div class='ug-tiles-wrapper' style='position:relative'></div>"
      ),
      1 == w.showPreloader &&
        (c.append("<div class='ug-tiles-preloader ug-preloader-trans'></div>"),
        (g = c.children(".ug-tiles-preloader")),
        g.fadeTo(0, 0)),
      (p = c.children(".ug-tiles-wrapper")),
      b.theme_gallery_padding &&
        c.css({
  ...
  function n() {
    g &&
      (g.fadeTo(0, 1),
      c.height(b.theme_preloading_height),
      _.placeElement(g, "center", b.theme_preloader_vertpos)),
      l(),
      m.run(),
      f.run();
  }
  ...
  function o() {
    null !== b.theme_auto_open &&
      (f.open(b.theme_auto_open), (b.theme_auto_open = null));
  }
  function l() {
    g &&
  ...
  var u,
    ...
    w = { showPreloader: !1 };
  (this.destroy = function () {
    jQuery(v).off(v.events.TILE_CLICK),
      h.destroyEvent(m.events.TILES_FIRST_PLACED),
      u.off(h.events.GALLERY_BEFORE_REQUEST_ITEMS),
      jQuery(f).off(f.events.LIGHTBOX_INIT),
      m.destroy(),
      f.destroy();
  }),
    (this.run = function () {
    ...
    t = function (n, r) {
      ...
      function s() {
        ...
        t.attr("data-swiper-autoplay") &&
          (e = t.attr("data-swiper-autoplay") || w.params.autoplay),
      ...
      function u(e) {
        ...
        if (
          ...
          if (37 === t || 39 === t || 38 === t || 40 === t) {
            var i = !1;
            if (
              w.container.parents("." + w.params.slideClass).length > 0 &&
              0 === w.container.parents("." + w.params.slideActiveClass).length
            )
              return;
      ...
      function c(e) {
        ...
        if (w.params.mousewheelForceToAxis)
          ...
          t =
            Math.abs(n.pixelX) > Math.abs(n.pixelY) ? -n.pixelX * i : -n.pixelY;
        if (0 !== t) {
          if ((w.params.mousewheelInvert && (t = -t), w.params.freeMode)) {
            var r =
                w.getWrapperTranslate() + t * w.params.mousewheelSensitivity,
              a = w.isBeginning,
              s = w.isEnd;
            if (
      ...
      for (var _ in r)
        if (
          ...
          r[_] === window ||
          r[_] === document ||
          (void 0 !== i && r[_] instanceof i) ||
          ("undefined" != typeof jQuery && r[_] instanceof jQuery)
        )
          f[_] = r[_];
        else {
          f[_] = {};
      ...
      if (
        ...
        (void 0 !== e ||
          (e =
            void 0 === i ? window.Dom7 || window.Zepto || window.jQuery : i)) &&
          ((w.$ = e),
        ...
        (w.container[0].swiper = w),
          ...
          w.classNames.push(
            w.params.containerModifierClass + w.params.direction
          ),
          w.params.freeMode &&
            w.classNames.push(w.params.containerModifierClass + "free-mode"),
          w.support.flexbox ||
            (w.classNames.push(w.params.containerModifierClass + "no-flexbox"),
            (w.params.slidesPerColumn = 1)),
          w.params.autoHeight &&
            w.classNames.push(w.params.containerModifierClass + "autoheight"),
          ...
          ["cube", "coverflow", "flip"].indexOf(w.params.effect) >= 0 &&
            (w.support.transforms3d
              ? ((w.params.watchSlidesProgress = !0),
                w.classNames.push(w.params.containerModifierClass + "3d"))
              : (w.params.effect = "slide")),
          "slide" !== w.params.effect &&
            w.classNames.push(
              w.params.containerModifierClass + w.params.effect
            ),
          ...
          ("fade" !== w.params.effect && "flip" !== w.params.effect) ||
            ...
            (w.params.watchSlidesProgress = !0),
            (w.params.spaceBetween = 0),
            void 0 === m && (w.params.virtualTranslate = !0)),
          ...
          w.params.pagination &&
            ...
            w.params.paginationClickable
              ? w.paginationContainer.addClass(
                  w.params.paginationModifierClass + "clickable"
                )
              : (w.params.paginationClickable = !1),
            w.paginationContainer.addClass(
              w.params.paginationModifierClass + w.params.paginationType
            )),
          ...
          w.params.slidesPerColumn > 1 &&
            w.classNames.push(w.params.containerModifierClass + "multirow"),
          w.device.android &&
            w.classNames.push(w.params.containerModifierClass + "android"),
          ...
          (w.preloadImages = function () {
            ...
            for (var t = 0; t < w.imagesToLoad.length; t++)
              w.loadImage(
                ...
                w.imagesToLoad[t].sizes ||
                  w.imagesToLoad[t].getAttribute("sizes"),
                !0,
                e
              );
          }),
          ...
          (w.startAutoplay = function () {
            return (
              ...
              !!w.params.autoplay &&
              !w.autoplaying &&
              ((w.autoplaying = !0), w.emit("onAutoplayStart", w), void s())
            );
          }),
            ...
            w.autoplayPaused ||
              ...
              0 === e
                ...
                : w.wrapper.transitionEnd(function () {
                    w &&
                      ((w.autoplayPaused = !1),
                      w.autoplaying ? s() : w.stopAutoplay());
                  }));
          }),
              ...
              for (e = 0; e < w.slides.length; e++) {
                ...
                if (w.params.slidesPerColumn > 1) {
                  ...
                  "column" === w.params.slidesPerColumnFill
                    ...
                    c
                      .css(
                        "margin-" + (w.isHorizontal() ? "top" : "left"),
                        0 !== h &&
          ...
          (w.currentSlidesPerView = function () {
            ...
            if (w.params.centeredSlides) {
              ...
              for (e = w.activeIndex + 1; e < w.slides.length; e++)
                w.slides[e] &&
                  !n &&
                  ((r += w.slides[e].swiperSlideSize),
                  i++,
                  r > w.size && (n = !0));
              for (t = w.activeIndex - 1; t >= 0; t--)
                w.slides[t] &&
                  !n &&
                  ((r += w.slides[t].swiperSlideSize),
                  i++,
                  r > w.size && (n = !0));
            } else
              for (e = w.activeIndex + 1; e < w.slides.length; e++)
            ...
            if (
              ...
              for (var i = 0; i < w.slides.length; i++) {
                var n = w.slides[i],
                  r =
                    (t +
                      (w.params.centeredSlides ? w.minTranslate() : 0) -
                      n.swiperSlideOffset) /
          ...
          (w.updateRealIndex = function () {
            w.realIndex = parseInt(
              w.slides.eq(w.activeIndex).attr("data-swiper-slide-index") ||
                w.activeIndex,
              10
            );
          }),
          (w.updateClasses = function () {
              ...
              r.loop &&
                (t.hasClass(w.params.slideDuplicateClass)
                  ? w.wrapper
                      ...
                      .addClass(w.params.slideDuplicateActiveClass)
                  : w.wrapper
                      .children(
                        "." +
                          w.params.slideClass +
            ...
            w.params.loop &&
              0 === i.length &&
              ((i = w.slides.eq(0)), i.addClass(w.params.slideNextClass));
            var n = t
            ...
            if (
              (w.params.loop &&
                0 === n.length &&
                ((n = w.slides.eq(-1)), n.addClass(w.params.slidePrevClass)),
              r.loop &&
              ...
              if (
                (w.params.loop
                  ? ((a = Math.ceil(
                      (w.activeIndex - w.loopedSlides) / w.params.slidesPerGroup
                    )),
                ...
                w.isHorizontal() || ((u = o), (l = 1)),
                  w.paginationContainer
                    ...
                    .transform(
                      "translate3d(0,0,0) scaleX(" + l + ") scaleY(" + u + ")"
                    )
              ...
              "custom" === w.params.paginationType &&
                ...
                (w.paginationContainer.html(
                  w.params.paginationCustomRender(w, a + 1, s)
                ),
          ...
          (w.touchEvents = {
            start:
              w.support.touch || !w.params.simulateTouch
                ? "touchstart"
                : w.touchEventsDesktop.start,
            move:
              w.support.touch || !w.params.simulateTouch
                ? "touchmove"
                : w.touchEventsDesktop.move,
            end:
              w.support.touch || !w.params.simulateTouch
                ? "touchend"
                : w.touchEventsDesktop.end,
          }),
          (window.navigator.pointerEnabled ||
            window.navigator.msPointerEnabled) &&
          ...
          (w.initEvents = function (e) {
            ...
            if (w.browser.ie)
              n[i](w.touchEvents.start, w.onTouchStart, !1),
                a[i](w.touchEvents.move, w.onTouchMove, s),
                a[i](w.touchEvents.end, w.onTouchEnd, !1);
            else {
              if (w.support.touch) {
                var o = !(
                  "touchstart" !== w.touchEvents.start ||
                  !w.support.passiveListener ||
                  !w.params.passiveListeners
                ) && { passive: !0, capture: !1 };
                n[i](w.touchEvents.start, w.onTouchStart, o),
                  n[i](w.touchEvents.move, w.onTouchMove, s),
                  n[i](w.touchEvents.end, w.onTouchEnd, o);
              }
              ((r.simulateTouch && !w.device.ios && !w.device.android) ||
                (r.simulateTouch && !w.support.touch && w.device.ios)) &&
                (n[i]("mousedown", w.onTouchStart, !1),
                document[i]("mousemove", w.onTouchMove, s),
          ...
          (w.updateClickedSlide = function (t) {
            ...
            if (
              ...
              var a,
                ...
                l =
                  "auto" === w.params.slidesPerView
                    ? w.currentSlidesPerView()
                    : w.params.slidesPerView;
              if (w.params.loop) {
                if (w.animating) return;
                (a = parseInt(
                  e(w.clickedSlide).attr("data-swiper-slide-index"),
                  10
                )),
                  w.params.centeredSlides
                    ? s < w.loopedSlides - l / 2 ||
                      s > w.slides.length - w.loopedSlides + l / 2
                      ? (w.fixLoop(),
                        (s = w.wrapper
                          .children(
                            "." +
        ...
        (w.onTouchStart = function (t) {
          if (
            ...
            if (w.params.noSwiping && o(t, "." + w.params.noSwipingClass))
            ...
            if (
                ...
                if (w.isHorizontal()) {
                  if (
                    (w.touches.currentX < w.touches.startX &&
                      w.translate <= w.maxTranslate()) ||
                    (w.touches.currentX > w.touches.startX &&
                      w.translate >= w.minTranslate())
                  )
                    return;
                } else if (
              ...
              if (
                ...
                if (
                  ...
                  (w.isHorizontal() &&
                    w.touches.currentY === w.touches.startY) ||
                  (!w.isHorizontal() && w.touches.currentX === w.touches.startX)
                    ? (P = !1)
                    : ((i =
                        (180 *
                          Math.atan2(
                ...
                if (
                  (P && w.emit("onTouchMoveOpposite", w, t),
                  void 0 === N &&
                    ((w.touches.currentX === w.touches.startX &&
                      w.touches.currentY === w.touches.startY) ||
                      (N = !0)),
                  ...
                  if (N) {
                    ...
                    if (
                      ...
                      if (!(Math.abs(n) > w.params.threshold || A))
                        return void (C = j);
                      if (!A)
                        return (
                          (A = !0),
                    ...
                    w.params.followFinger &&
                      ...
                      w.params.freeMode &&
                        (0 === L.length &&
                          L.push({
                            position:
                              w.touches[w.isHorizontal() ? "startX" : "startY"],
                            time: E,
                          }),
                        L.push({
                          position:
            ...
            if (
              ...
              if (
                (w.allowClick &&
                  ...
                  n < 300 &&
                    i - k < 300 &&
                    (M && clearTimeout(M), w.emit("onDoubleTap", w, t))),
                (k = Date.now()),
                setTimeout(function () {
                  w && (w.allowClick = !0);
                }, 0),
              ...
              if (
                ...
                if (w.params.freeModeMomentum) {
                  if (L.length > 1) {
                    ...
                    (w.velocity = o / l),
                      ...
                      Math.abs(w.velocity) < w.params.freeModeMinimumVelocity &&
                        (w.velocity = 0),
                      (l > 150 || new window.Date().getTime() - a.time > 300) &&
                        (w.velocity = 0);
                  } else w.velocity = 0;
                  (w.velocity =
                    w.velocity * w.params.freeModeMomentumVelocityRatio),
                    (L.length = 0);
                  ...
                  if (c < w.maxTranslate())
                    ...
                    w.params.freeModeMomentumBounce
                      ? (c - w.minTranslate() > h && (c = w.minTranslate() + h),
                        (g = w.minTranslate()),
                        (p = !0),
                        (z = !0))
                      : (c = w.minTranslate());
                ...
                return void (
                  (!w.params.freeModeMomentum || n >= w.params.longSwipesMs) &&
              ...
              for (_ = 0; _ < w.slidesGrid.length; _ += w.params.slidesPerGroup)
                void 0 !== w.slidesGrid[_ + w.params.slidesPerGroup]
                  ? r >= w.slidesGrid[_] &&
                    r < w.slidesGrid[_ + w.params.slidesPerGroup] &&
                    ((v = _),
                    (b =
                      w.slidesGrid[_ + w.params.slidesPerGroup] -
                      w.slidesGrid[_]))
                  : r >= w.slidesGrid[_] &&
                    ((v = _),
                    (b =
              ...
              if (n > w.params.longSwipesMs) {
                ...
                "next" === w.swipeDirection &&
                  (y >= w.params.longSwipesRatio
                    ? w.slideTo(v + w.params.slidesPerGroup)
                    : w.slideTo(v)),
                  "prev" === w.swipeDirection &&
                    (y > 1 - w.params.longSwipesRatio
                      ? w.slideTo(v + w.params.slidesPerGroup)
                      : w.slideTo(v));
              } else {
          ...
          (w.slideTo = function (e, t, i, n) {
            ...
            if (
              ...
              for (var a = 0; a < w.slidesGrid.length; a++)
                -Math.floor(100 * r) >= Math.floor(100 * w.slidesGrid[a]) &&
                  (e = a);
            return !(
              (!w.params.allowSwipeToNext &&
                r < w.translate &&
              ...
              (w.rtl && -r === w.translate) || (!w.rtl && r === w.translate)
                ? (w.params.autoHeight && w.updateAutoHeight(),
                  w.updateClasses(),
                  "slide" !== w.params.effect && w.setWrapperTranslate(r),
                  1)
                : (w.updateClasses(),
          ...
          (w.onTransitionEnd = function (e) {
            (w.animating = !1),
              ...
              w.params.history &&
                w.history &&
                w.history.setHistory(w.params.history, w.activeIndex),
            ...
            w.isHorizontal() ? (n = w.rtl ? -e : e) : (r = e),
              ...
              w.params.virtualTranslate ||
                (w.support.transforms3d
                  ...
                  : w.wrapper.transform("translate(" + n + "px, " + r + "px)")),
          ...
          (w.createLoop = function () {
            ...
            for (
              t.each(function (i, a) {
                var s = e(this);
                i < w.loopedSlides && r.push(a),
                  i < t.length && i >= t.length - w.loopedSlides && n.push(a),
              ...
              w.wrapper.append(
                e(r[i].cloneNode(!0)).addClass(w.params.slideDuplicateClass)
              );
            for (i = n.length - 1; i >= 0; i--)
              w.wrapper.prepend(
                e(n[i].cloneNode(!0)).addClass(w.params.slideDuplicateClass)
              );
          }),
              ...
              setTranslate: function () {
                ...
                for (var n = 0; n < w.slides.length; n++) {
                  ...
                  n % 4 == 0
                    ...
                    : (n - 3) % 4 == 0 &&
                      ((l = -w.size), (d = 3 * w.size + 4 * w.size * s)),
                    w.rtl && (l = -l),
                  ...
                  if (
                    (o <= 1 &&
                      o > -1 &&
                      ((i = 90 * n + 90 * o), w.rtl && (i = 90 * -n - 90 * o)),
                    r.transform(c),
                    w.params.cube.slideShadows)
                  ) {
                    var g = w.isHorizontal()
          ...
          (w.lazy = {
            ...
            loadImageInSlide: function (t, i) {
              if (
                ...
                var n = w.slides.eq(t),
                  r = n.find(
                    "." +
                      w.params.lazyLoadingClass +
                      ":not(." +
                      w.params.lazyStatusLoadedClass +
                      "):not(." +
                      w.params.lazyStatusLoadingClass +
                      ")"
                  );
                !n.hasClass(w.params.lazyLoadingClass) ||
                  n.hasClass(w.params.lazyStatusLoadedClass) ||
                  n.hasClass(w.params.lazyStatusLoadingClass) ||
                  (r = r.add(n[0])),
                  0 !== r.length &&
                    r.each(function () {
                      var t = e(this);
                          ...
                          if (
                            (r
                              ...
                              : (s &&
                                ...
                                a &&
                                  (t.attr("src", a), t.removeAttr("data-src"))),
                            t
                              .addClass(w.params.lazyStatusLoadedClass)
                              .removeClass(w.params.lazyStatusLoadingClass),
                            n
                              .find(
                                "." +
                                  w.params.lazyPreloaderClass +
                                  ", ." +
                                  w.params.preloaderClass
                              )
                              .remove(),
                            w.params.loop && i)
                          ) {
            ...
            load: function () {
              ...
              if (
                ...
                for (t = w.activeIndex; t < w.activeIndex + i; t++)
              ...
              if (w.params.lazyLoadingInPrevNext)
                if (
                  ...
                  var n = w.params.lazyLoadingInPrevNextAmount,
                    r = i,
                    a = Math.min(
                      w.activeIndex + r + Math.max(n, r),
                      w.slides.length
                    ),
                    s = Math.max(w.activeIndex - Math.max(r, n), 0);
                  for (t = w.activeIndex + i; t < a; t++)
                    w.slides[t] && w.lazy.loadImageInSlide(t);
                  for (t = s; t < w.activeIndex; t++)
                    w.slides[t] && w.lazy.loadImageInSlide(t);
                } else {
          ...
          (w.scrollbar = {
            ...
            draggableEvents: (function () {
              return w.params.simulateTouch !== !1 || w.support.touch
                ? w.touchEvents
                : w.touchEventsDesktop;
            })(),
              ...
              function n(t) {
                (e =
                  ...
                  "slide" === w.params.controlBy &&
                    ...
                    (a = -w.controller.spline.interpolate(-e))),
                  (a && "container" !== w.params.controlBy) ||
                    ((r =
                      (t.maxTranslate() - t.minTranslate()) /
                      (w.maxTranslate() - w.minTranslate())),
                    (a = (e - w.minTranslate()) * r + t.minTranslate())),
          ...
          (w.hashnav = {
            onHashCange: function (e, t) {
              ...
              i !== w.slides.eq(w.activeIndex).attr("data-hash") &&
                w.slideTo(
                  w.wrapper
                    .children(
                      "." + w.params.slideClass + '[data-hash="' + i + '"]'
                    )
                    .index()
                );
            },
          ...
          (w.history = {
            init: function () {
              if (w.params.history) {
                if (!window.history || !window.history.pushState)
                  return (w.params.history = !1), void (w.params.hashnav = !0);
            ...
            setHistoryPopState: function () {
              (w.history.paths = w.history.getPathValues()),
                w.history.scrollToSlide(
                  w.params.speed,
                  w.history.paths.value,
                  !1
                );
            },
          ...
          (w.disableMousewheelControl = function () {
            ...
            var t = w.container;
            return (
              "container" !== w.params.mousewheelEventsTarged &&
                (t = e(w.params.mousewheelEventsTarged)),
              t.off(w.mousewheel.event, c),
          ...
          (w.zoom = {
            ...
            onGestureChange: function (e) {
              ...
              t.gesture.image &&
                ...
                t.scale < w.params.zoomMin &&
                  (t.scale =
                    w.params.zoomMin +
                    1 -
                    Math.pow(w.params.zoomMin - t.scale + 1, 0.5)),
            ...
            onTouchMove: function (e) {
              ...
              if (
                t.gesture.image &&
                0 !== t.gesture.image.length &&
                ((w.allowClick = !1), t.image.isTouched && t.gesture.slide)
              ) {
                t.image.isMoved ||
                  ((t.image.width = t.gesture.image[0].offsetWidth),
                  (t.image.height = t.gesture.image[0].offsetHeight),
                  (t.image.startX =
                    w.getTranslate(t.gesture.imageWrap[0], "x") || 0),
                  (t.image.startY =
                    w.getTranslate(t.gesture.imageWrap[0], "y") || 0),
            ...
            onTouchEnd: function (e, t) {
              ...
              if (i.gesture.image && 0 !== i.gesture.image.length) {
                ...
                0 !== i.velocity.x &&
                  (n = Math.abs((s - i.image.currentX) / i.velocity.x)),
                  0 !== i.velocity.y &&
                    (r = Math.abs((l - i.image.currentY) / i.velocity.y));
                var u = Math.max(n, r);
            ...
            attachEvents: function (t) {
              ...
              if (w.params.zoom) {
                ...
                w.support.gestures
                  ? (w.slides[i]("gesturestart", w.zoom.onGestureStart, n),
                    w.slides[i]("gesturechange", w.zoom.onGestureChange, n),
                    w.slides[i]("gestureend", w.zoom.onGestureEnd, n))
                  : "touchstart" === w.touchEvents.start &&
                    (w.slides[i](w.touchEvents.start, w.zoom.onGestureStart, n),
                    w.slides[i](w.touchEvents.move, w.zoom.onGestureChange, n),
                    w.slides[i](w.touchEvents.end, w.zoom.onGestureEnd, n)),
                  w[i]("touchStart", w.zoom.onTouchStart),
                  w.slides.each(function (t, n) {
                    e(n).find("." + w.params.zoomContainerClass).length > 0 &&
                      e(n)[i](w.touchEvents.move, w.zoom.onTouchMove);
                  }),
          ...
          (w.init = function () {
            w.params.loop && w.createLoop(),
              ...
              w.params.mousewheelControl &&
                ...
                w.enableMousewheelControl(),
              w.params.hashnavReplaceState &&
                (w.params.replaceState = w.params.hashnavReplaceState),
        ...
        return (
          (e.prototype = {
            ...
            on: function (e, i, n, r) {
              function a(e) {
                ...
                if (t(r).is(i)) n.call(r, e);
                  ...
                  for (var a = t(r).parents(), s = 0; s < a.length; s++)
                    t(a[s]).is(i) && n.call(a[s], e);
              }
              var s,
                o,
                l = e.split(" ");
            ...
            transitionEnd: function (e) {
              function t(a) {
                if (a.target === this)
                  for (e.call(this, a), i = 0; i < n.length; i++)
                    r.off(n[i], t);
              }
              var i,
                n = [
              ...
              for (var i = t(e), n = 0; n < this.length; n++)
                if (1 === i.length) i[0].parentNode.insertBefore(this[n], i[0]);
                  ...
                  for (var r = 0; r < i.length; r++)
                    i[r].parentNode.insertBefore(this[n].cloneNode(!0), i[r]);
            },
            ...
            parents: function (e) {
              for (var i = [], n = 0; n < this.length; n++)
                for (var r = this[n].parentNode; r; )
                  e ? t(r).is(e) && i.push(r) : i.push(r), (r = r.parentNode);
              return t(t.unique(i));
            },
            find: function (t) {
              for (var i = [], n = 0; n < this.length; n++)
                for (
                  var r = this[n].querySelectorAll(t), a = 0;
                  a < r.length;
                  a++
                )
                  i.push(r[a]);
            ...
            children: function (i) {
              for (var n = [], r = 0; r < this.length; r++)
                for (var a = this[r].childNodes, s = 0; s < a.length; s++)
                  i
                    ? 1 === a[s].nodeType && t(a[s]).is(i) && n.push(a[s])
                    : 1 === a[s].nodeType && n.push(a[s]);
    ...
    (i.prototype = {
      ...
      fit: function (e) {
        var t,
          ...
          r = e.length,
          a = r > 0 ? e[0].h : 0;
        for (this.root.h = a, t = 0; t < r; t++)
          (n = e[t]),
            (i = this.findNode(this.root, n.w, n.h))
              ? (n.fit = this.splitNode(i, n.w, n.h))
              : (n.fit = this.growDown(n.w, n.h));
      },
      findNode: function (e, t, i) {
        return e.used
          ? this.findNode(e.right, t, i) || this.findNode(e.down, t, i)
          : t <= e.w && i <= e.h
          ? e
          : null;
      },
      splitNode: function (e, t, i) {
        return (
          (e.used = !0),
          (e.down = { x: e.x, y: e.y + i, w: e.w, h: e.h - i }),
          (e.right = { x: e.x + t, y: e.y, w: e.w - t, h: i }),
          e
        );
      },
      ...
      (t.fn.filterizr = function () {
        ...
        if (
          (e._fltr ||
            (e._fltr = t.fn.filterizr.prototype.init(
              e,
              "object" == typeof i[0] ? i[0] : void 0
            )),
          "string" == typeof i[0])
        ) {
          if (i[0].lastIndexOf("_") > -1)
            throw new Error("Filterizr error: You cannot call private methods");
          if ("function" != typeof e._fltr[i[0]])
      ...
      (t.fn.filterizr.prototype = {
        init: function (e, i) {
          ...
          return (
            ...
            (n._uID = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(
              /[xy]/g,
              function (e) {
        ...
        filter: function (e) {
          ...
          (t.options.filter = e),
            ...
            t._handleFiltering(i),
            t._isSearchActivated() && t.search(t._typedText);
        },
        toggleFilter: function (e) {
          ...
          t.trigger("filteringStart"),
            e &&
              (t._toggledCategories[e]
                ? delete t._toggledCategories[e]
                : (t._toggledCategories[e] = !0)),
            t._multifilterModeOn()
              ? ((i = t._makeMultifilterArray()),
                t._handleFiltering(i),
                t._isSearchActivated() && t.search(t._typedText))
              : (t.filter("all"),
                t._isSearchActivated() && t.search(t._typedText));
        ...
        search: function (e) {
          ...
          if (t._isSearchActivated())
            for (r = 0; r < i.length; r++)
              i[r].text().toLowerCase().indexOf(e.toLowerCase()) > -1 &&
                n.push(i[r]);
          if (n.length > 0) t._handleFiltering(n);
          else if (t._isSearchActivated())
            for (r = 0; r < t._activeArray.length; r++)
              t._activeArray[r]._filterOut();
        ...
        shuffle: function () {
          ...
          (e._isAnimating = !0),
            ...
            (e._mainArray = e._fisherYatesShuffle(e._mainArray)),
            (e._subArrays = e._makeSubarrays());
          var t = e._multifilterModeOn()
            ? e._makeMultifilterArray()
        ...
        sort: function (e, t) {
          ...
          if (
            ...
            "domIndex" !== e && "sortData" !== e && "w" !== e && "h" !== e)
          )
            for (var n = 0; n < i._mainArray.length; n++)
              i._mainArray[n][e] = i._mainArray[n].data(e);
          i._mainArray.sort(i._comparator(e, t)),
            (i._subArrays = i._makeSubarrays());
          var r = i._multifilterModeOn()
        ...
        setOptions: function (e) {
          ...
          if (
            t._mainArray &&
            (e.animationDuration || e.delay || e.easing || e.delayMode)
          )
            for (i = 0; i < t._mainArray.length; i++)
              t._mainArray[i].css(
                ...
                "all " +
                  ...
                  t.options.easing +
                  " " +
                  t._mainArray[i]._calcDelay() +
                  "ms"
              );
          e.callbacks &&
            (e.callbacks.onFilteringStart ||
              (t.options.callbacks.onFilteringStart = function () {}),
            e.callbacks.onFilteringEnd ||
              (t.options.callbacks.onFilteringEnd = function () {}),
            e.callbacks.onShufflingStart ||
              (t.options.callbacks.onShufflingStart = function () {}),
            e.callbacks.onShufflingEnd ||
              (t.options.callbacks.onShufflingEnd = function () {}),
            e.callbacks.onSortingStart ||
              (t.options.callbacks.onSortingStart = function () {}),
            e.callbacks.onSortingEnd ||
              (t.options.callbacks.onSortingEnd = function () {})),
            t.options.filterInCss.transform ||
              (t.options.filterInCss.transform = "translate3d(0,0,0)"),
            t.options.filterOutCss.transform ||
              (t.options.filterOutCss.transform = "translate3d(0,0,0)");
        },
        ...
        _makeSubarrays: function () {
          for (var e = this, t = [], i = 0; i < e._lastCategory; i++)
            t.push([]);
          for (i = 0; i < e._mainArray.length; i++)
            if ("object" == typeof e._mainArray[i]._category)
              for (var n = e._mainArray[i]._category.length, r = 0; r < n; r++)
                t[e._mainArray[i]._category[r] - 1].push(e._mainArray[i]);
        ...
        _setupControls: function () {
          ...
          t("*[data-filter]").click(function () {
            ...
            t("*[data-multifilter]").click(function () {
              ...
              "all" === i
                ? ((e._toggledCategories = {}), e.filter("all"))
                : e.toggleFilter(i);
            }),
        ...
        _calcItemPositions: function () {
          ...
          if ("packed" === e.options.layout) {
            ...
            for (h.fit(e._activeArray), c = 0; c < n.length; c++)
              p.push({ left: n[c].fit.x, top: n[c].fit.y });
            r = h.root.h;
          }
          if ("horizontal" === e.options.layout)
            for (s = 1, c = 1; c <= n.length; c++)
              (o = n[c - 1].outerWidth()),
                (l = n[c - 1].outerHeight()),
                p.push({ left: u, top: d }),
                (u += o),
        ...
        _handleFiltering: function (e) {
          for (
            var t = this,
              i = t._getArrayOfUniqueItems(t._activeArray, e),
              n = 0;
            n < i.length;
            n++
          )
        ...
        _placeItems: function (e) {
          ...
          for (var i = 0; i < e.length; i++)
            e[i]._filterIn(t._itemPositions[i]);
        },
    ...
    var n = {
      ...
      _calcDelay: function () {
        var e = this,
          t = 0;
        return (
          "progressive" === e._parent.options.delayMode
            ? (t = e._parent.options.delay * e.domIndex)
            : e.domIndex % 2 == 0 && (t = e._parent.options.delay),
          t
        );
      },
      _getCategory: function () {
        ...
        if ("string" == typeof t) {
          ...
          for (var i = 0; i < t.length; i++) {
            ...
            parseInt(t[i]) > e._parent._lastCategory &&
              (e._parent._lastCategory = parseInt(t[i]));
          }
      ...
      _onTransitionEnd: function () {
        var e = this;
        e._filteringOut
          ? (t(e).addClass("filteredOut"),
            (e._isFilteredOut = !0),
            (e._filteringOut = !1))
          : e._filteringIn && ((e._isFilteredOut = !1), (e._filteringIn = !1)),
          e._parent._isAnimating &&
            (e._parent._isShuffling
              ? e._parent.trigger("shufflingEnd")
              : e._parent._isSorting
              ? e._parent.trigger("sortingEnd")
              : e._parent.trigger("filteringEnd"),
            (e._parent._isAnimating = !1));
      },
      _filterOut: function () {
        var e = this,
      ...
      _filterIn: function (e) {
        ...
        t(i).removeClass("filteredOut"),
          (i._filteringIn = !0),
          (i._lastPos = e),
          i.css("pointer-events", "auto"),
          (n.transform += " translate3d(" + e.left + "px," + e.top + "px, 0)"),
          i.css(n);
      },
    };
  })(this, jQuery);
...
!(function (e, t) {
  ...
  function u(e) {
    if (
      (e = /([\+\-]?[0-9#\.]+)(%|px|pt|em|rem|in|cm|mm|ex|pc|vw|vh|deg|rad|turn)?/.exec(
        e
      ))
    )
      return e[2];
  ...
  function p(e, t) {
    return L.dom(e) && n(k, t)
      ? "transform"
      : L.dom(e) && (e.getAttribute(t) || (L.svg(e) && e[t]))
      ? "attribute"
      : L.dom(e) && "transform" !== t && g(e, t)
      ? "css"
      : null != e[t]
      ? "object"
      : void 0;
  ...
  function h(e, t) {
    ...
    for (var n = [], r = [], a = [], s = /(\w+)\((.+?)\)/g; (n = s.exec(e)); )
  ...
  function b(e, t) {
    var i = /-?\d*\.?\d+/g;
    if (((e = _(e) ? e.totalLength : e), L.col(e)))
      t = L.rgb(e) ? e : L.hex(e) ? o(e) : L.hsl(e) ? l(e) : void 0;
    else {
      var n = u(e);
  ...
  function x(e, t) {
    ...
    if (L.arr(e)) {
      var a = e.length;
      2 !== a || L.obj(e[0])
        ? L.fnc(t.duration) || (n.duration = t.duration / a)
        : (e = { value: e });
    }
    return i(e)
      .map(function (e, i) {
        return (
          (i = i ? 0 : t.delay),
          (e = L.obj(e) && !_(e) ? e : { value: e }),
          L.und(e.delay) && (e.delay = i),
          e
        );
      })
      .map(function (e) {
  ...
  function j(e) {
    ...
    for (t in e)
      l.hasOwnProperty(t) ||
        "targets" === t ||
        o.push({ name: t, offset: l.offset, tweens: x(e[t], n) });
    return (
      (e = P(r, o)),
      s(i, {
        children: [],
  ...
  function A(e) {
    ...
    function n(e) {
      for (var t = 0, i = {}, n = p.animations, r = {}; t < n.length; ) {
        ...
        (r.tween =
          ...
          (r.eased = r.tween.easing(
            Math.min(
              Math.max(e - r.tween.start - r.tween.delay, 0),
              r.tween.duration
            ) / r.tween.duration,
            r.tween.elasticity
          )),
          (o = y(
            r.tween.to.numbers.map(
              (function (e) {
                return function (t, i) {
                  return (
                    (i = e.isPath$1 ? 0 : e.tween.from.numbers[i]),
                    (t = i + e.eased * (t - i)),
                    e.isPath$1 && (t = v(e.tween.value, t)),
                    e.round && (t = Math.round(t * e.round) / e.round),
                    t
                  );
                };
              })(r)
      ...
      if (i)
        for (var l in i)
          M ||
            (M = g(document.body, "transform")
              ? "transform"
              : "-webkit-transform"),
            (p.animatables[l].target.style[M] = i[l].join(" "));
    ...
    function s(e) {
      ...
      _ > g && _ < s
        ? (n(_), !p.began && _ >= h && ((p.began = !0), r("begin")), r("run"))
        : (_ <= g && 0 !== m && (n(0), f && a()),
          _ >= s && m !== s && (n(s), f || a())),
        e >= s &&
          (p.remaining
            ...
            : (p.pause(),
              "Promise" in window && (d(), (c = t())),
              p.completed || ((p.completed = !0), r("complete"))),
          (u = 0)),
        r("update");
    }
    e = void 0 === e ? {} : e;
    ...
    H = (function () {
      ...
      return function (t, i, n, r) {
        if (0 <= t && 1 >= t && 0 <= n && 1 >= n) {
          ...
          if (t !== i || n !== r)
            for (var s = 0; 11 > s; ++s) a[s] = e(0.1 * s, t, n);
          return function (s) {
            if (t === i && n === r) return s;
            if (0 === s) return 0;
            if (1 === s) return 1;
      ...
      for (t in n)
        (a.type = t),
          n[a.type].forEach(
            (function (e) {
              return function (t, n) {
                r["ease" + e.type + i[n]] = L.fnc(t)
                  ? t
                  : H.apply($jscomp$this, t);
              };
            })(a)
          ),
          (a = { type: a.type });
  ...
  return (
    ...
    (A.remove = function (e) {
      ...
      for (var t = R.length; t--; )
        for (var i = R[t], r = i.animations, a = r.length; a--; )
          n(e, r[a].animatable.target) &&
            (r.splice(a, 1), r.length || i.pause());
    }),
    (A.getValue = m),
    (A.path = function (t, i) {
          ...
          return (
            ...
            i(e).forEach(function (e) {
              var i = t.duration,
                n = e.offset;
              (e.autoplay = !1),
                (e.offset = L.und(n) ? i : f(n, i)),
                t.seek(e.offset),
                (e = A(e)),
                e.duration > i && (t.duration = e.duration),
                (e.began = !0),
                t.children.push(e);
            }),
            t.reset(),
    ...
    e.extend(e.easing, {
      ...
      easeInOutElastic: function (e) {
        return 0 === e
          ...
          ? 1
          : 0.5 > e
          ? -(i(2, 20 * e - 10) * r((20 * e - 11.125) * c)) / 2
          : (i(2, -20 * e + 10) * r((20 * e - 11.125) * c)) / 2 + 1;
      },
  ...
  !(function (e, t) {
    ...
    function n(t) {
      ...
      return (
        ...
        n.length
          ? ("0,0,0,0" === n.join() && e.extend(n, a.transparent), i)
          : a[t]
      );
    }
    function r(e, t, i) {
    ...
    (p.style.cssText = "background-color:rgba(1,1,1,.5)"),
                  ...
                  : h(d, function (t, n) {
                      ...
                      h(n.props, function (e, t) {
                        ...
                        c[a] &&
                          ...
                          ((c[a][3] = 1), n.from && (c._rgba = n.from(c[a])));
                    }),
                this)
              : void 0
          );
        ...
        return (
          (t =
            l === o
              ...
              ? (60 * (a - n)) / u + 120
              : (60 * (n - r)) / u + 240),
          (i = 0 === u ? 0 : 0.5 >= c ? u / d : u / (2 - d)),
          [Math.round(t) % 360, i, c, null == s ? 1 : s]
        );
      }),
      ...
      h(d, function (n, r) {
        var a = r.props,
          ...
          d = r.from;
        (u.fn[n] = function (n) {
          if ((l && !this[s] && (this[s] = l(this._rgba)), n === t))
            return this[s].slice();
          var r,
            o = e.type(n),
      ...
      (e.fn.ismouseover = function () {
        ...
        return (
          this.eq(0).each(function () {
            var i = e(this).is("iframe")
                ? e(this).contents().find("body")
                : e(this),
              n = i.offset();
            t =
              n.left <= e.mlp.x &&
              n.left + i.outerWidth() > e.mlp.x &&
              n.top <= e.mlp.y &&
              n.top + i.outerHeight() > e.mlp.y;
          }),
          t
        );
      });
        ...
        prototype: {
            ...
            return e(this.currentForm)
              ...
              .filter(function () {
                return (
                  ...
                  !(this.name in i || !t.objectLength(e(this).rules())) &&
                    ((i[this.name] = !0), !0)
                );
              });
          },
          ...
          formatAndAdd: function (t, i) {
            ...
            "function" == typeof n
              ...
              : r.test(n) &&
                (n = e.validator.format(n.replace(r, "{$1}"), i.parameters)),
                          ...
                          (r.settings.messages[i.name].remote =
                            ...
                            u
                              ...
                              : ((a = {}),
                                ...
                                (a[i.name] = s.message = e.isFunction(o)
                                  ? o(t)
                                  : o),
                                (r.invalid[i.name] = !0),
                                r.showErrors(a)),
    ...
    e.ajaxPrefilter
      ...
      : ((t = e.ajax),
        (e.ajax = function (n) {
          ...
          return "abort" === r
            ? (i[a] && i[a].abort(), (i[a] = t.apply(this, arguments)), i[a])
